...
class ILocalCallInvitation {
 ...
 public:
  ...
  /**
   ...
   meta::rtm::ILocalCallInvitation::setContent "setContent" method.
   */
  ...
  /**
   ...
   @note To intercommunicate with the legacy Meta Signaling SDK, you MUST set
   the channel ID. However, even if the callee successfully accepts the call
   invitation, the Meta RTM SDK does not join the channel of the specified
   channel ID.
  ...
  /**
   ...
   meta::rtm::IRemoteCallInvitation::setResponse "setResponse" method.
   */
...
class IRemoteCallInvitation {
 ...
 public:
  ...
  /**
   ...
   \ref meta::rtm::IRemoteCallInvitation::setResponse "setResponse" method.
   */
  virtual const char* getResponse() const = 0;
...
class IRtmCallManager {
 ...
 public:
  /**
   ...
   @param invitation An \ref meta::rtm::ILocalCallInvitation
  ...
  /**
   ...
   @param invitation An \ref meta::rtm::IRemoteCallInvitation
  ...
  /**
   Creates an ILocalCallInvitation object.
       ...
       @return An \ref meta::rtm::ILocalCallInvitation "ILocalCallInvitation"
   object.
   */
