...
class IAudioFrameObserver {
  ...
  */
  ...
  /** Determines whether to receive audio data from multiple channels.
   ...
   In the multi-channel scenario, Wuji recommends setting the return value as true.
...
class IVideoFrameObserver {
 ...
 public:
  ...
  /** Determines whether to receive video data from multiple channels.
   ...
   send the video frame. onRenderVideoFrame will not be triggered. In the multi-channel scenario, Wuji recommends setting the return value as true.
...
class IMediaEngine {
 public:
  ...
  /** **DEPRECATED** Use \ref wuji::media::IMediaEngine::pushAudioFrame(IAudioFrameObserver::AudioFrame* frame) "pushAudioFrame(IAudioFrameObserver::AudioFrame* frame)" instead.
   ...
   * \ref wuji::media::IMediaEngine::pullAudioFrame "pullAudioFrame" method is as 
   * follows:
  ...
  virtual int pullAudioFrame(IAudioFrameObserver::AudioFrame* frame) = 0;
    ...
    */
    ...
    /** Pushes the video frame using the \ref ExternalVideoFrame "ExternalVideoFrame" and passes the video frame to the Wuji SDK.
