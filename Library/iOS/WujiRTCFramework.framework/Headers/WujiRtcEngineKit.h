...
/** Wuji provides ensured quality of experience (QoE) for worldwide Internet-based voice and video
 communications through a virtual global network optimized for real-time web and mobile-to-mobile
 applications.

 The WujiRtcEngineKit class is the entry point of the SDK providing API methods for apps to easily
...
/** The WujiRtcEngineDelegate protocol enables callbacks to your app.
 ...
 The SDK uses delegate callbacks in the WujiRtcEngineDelegate protocol to report runtime events to
 ...
 Wuji recommends replacing block callbacks with delegate callbacks. The SDK calls the block callback
...
[leaveChannel]([WujiRtcEngineKit leaveChannel:]) method to leave the channel.
...
/** Occurs when a method is executed by the SDK.
 ...
 @param engine WujiRtcEngineKit object.
 @param error  The error code (WujiErrorCode) returned by the SDK when the method call fails. If the
 SDK returns 0, then the method call succeeds.
 @param api    The method executed by the SDK.
 @param result The result of the method call.
 */
- (void)rtcEngine:(WujiRtcEngineKit *_Nonnull)engine
...
/** Occurs when the local user joins a specified channel.
 ...
 Same as `joinSuccessBlock` in the [joinChannelByToken]([WujiRtcEngineKit
 joinChannelByToken:channelId:info:uid:joinSuccess:]) method.

 @param engine  WujiRtcEngineKit object.
 @param channel Channel name.
 @param uid     User ID. If the `uid` is specified in the [joinChannelByToken]([WujiRtcEngineKit
 ...
 assigns a `uid`.
 @param elapsed Time elapsed (ms) from the user calling the [joinChannelByToken]([WujiRtcEngineKit
...
/** Occurs when the local user leaves a channel.
 ...
 When the app calls the [leaveChannel]([WujiRtcEngineKit leaveChannel:]) method, this callback
 ...
 the received/transmitted data reported by the [audioQualityOfUid]([WujiRtcEngineDelegate
 ...
 */
- (void)rtcEngine:(WujiRtcEngineKit *_Nonnull)engine
    didLeaveChannelWithStats:(WujiChannelStats *_Nonnull)stats;

/** Occurs when the local user successfully registers a user account by calling the
[registerLocalUserAccount]([WujiRtcEngineKit registerLocalUserAccount:appId:]) or
[joinChannelByUserAccount]([WujiRtcEngineKit joinChannelByUserAccount:token:channelId:joinSuccess:])
method.
...
@param engine WujiRtcEngineKit object.
@param userInfo The [WujiUserInfo](WujiUserInfo) object that contains the user ID and user account
of the remote user.
@param uid The ID of the remote user.
*/
- (void)rtcEngine:(WujiRtcEngineKit *_Nonnull)engine
    didUpdatedUserInfo:(WujiUserInfo *_Nonnull)userInfo
               withUid:(NSUInteger)uid;
...
[setClientRole]([WujiRtcEngineKit setClientRole:]) method after joining the channel.
...
/** Occurs when a remote user or host joins a channel. Same as [userJoinedBlock]([WujiRtcEngineKit
 userJoinedBlock:]).
 ...
 - A remote user/host joins the channel by calling the [joinChannelByToken]([WujiRtcEngineKit
 joinChannelByToken:channelId:info:uid:joinSuccess:]) method.
 - A remote user switches the user role to the host by calling the [setClientRole]([WujiRtcEngineKit
 ...
 [addInjectStreamUrl]([WujiRtcEngineKit addInjectStreamUrl:config:]) method.
 ...
 * When a web application joins the channel, the SDK triggers this callback as long as the web
 ...
 [joinChannelByToken]([WujiRtcEngineKit joinChannelByToken:channelId:info:uid:joinSuccess:]) method,
 the specified user ID is returned. If the `uid` is not specified in the joinChannelByToken method,
 the Wuji server automatically assigns a `uid`.
 @param elapsed Time elapsed (ms) from the local user calling the
 [joinChannelByToken]([WujiRtcEngineKit joinChannelByToken:channelId:info:uid:joinSuccess:]) or
 [setClientRole]([WujiRtcEngineKit setClientRole:]) method until the SDK triggers this callback.
 */
- (void)rtcEngine:(WujiRtcEngineKit *_Nonnull)engine
...
[userOfflineBlock]([WujiRtcEngineKit userOfflineBlock:]).
...
This callback is different from [rtcEngineConnectionDidInterrupted]([WujiRtcEngineDelegate
rtcEngineConnectionDidInterrupted:]):

- The SDK triggers the [rtcEngineConnectionDidInterrupted]([WujiRtcEngineDelegate
...
- The SDK triggers the [rtcEngineConnectionDidLost]([WujiRtcEngineDelegate
...
/** Occurs when the token expires in 30 seconds.
 ...
 The user becomes offline if the `token` used in the [joinChannelByToken]([WujiRtcEngineKit
 ...
 callback, generate a new `token` on the server and call the [renewToken]([WujiRtcEngineKit
...
/** Occurs when the token expires.
 ...
 After a `token` is specified by calling the [joinChannelByToken]([WujiRtcEngineKit
 joinChannelByToken:channelId:info:uid:joinSuccess:]) method, if the SDK losses connection to the
 Wuji server due to network issues, the `token` may expire after a certain period of time and a new
...
regardless of whether a user speaks or not.
 ...
 The SDK triggers two independent [reportAudioVolumeIndicationOfSpeakers]([WujiRtcEngineDelegate
...
in the [enableAudioVolumeIndication]([WujiRtcEngineKit
enableAudioVolumeIndication:smooth:report_vad:]) method.
 - Calling the [muteLocalAudioStream]([WujiRtcEngineKit muteLocalAudioStream:]) method affects the
behavior of the SDK:
 ...
 */
- (void)rtcEngine:(WujiRtcEngineKit *_Nonnull)engine
    reportAudioVolumeIndicationOfSpeakers:(NSArray<WujiRtcAudioVolumeInfo *> *_Nonnull)speakers
...
If the [startPreview]([WujiRtcEngineKit startPreview]) method is called before the
[joinChannelByToken]([WujiRtcEngineKit joinChannelByToken:channelId:info:uid:joinSuccess:]) method,
then `elapsed` is the time elapsed from calling the [startPreview]([WujiRtcEngineKit startPreview])
...
/** Occurs when a remote user's video stream playback pauses/resumes.
 ...
 You can also use the [remoteVideoStateChangedOfUid]([WujiRtcEngineDelegate
 ...
 calling the [muteLocalVideoStream]([WujiRtcEngineKit muteLocalVideoStream:]) method.
...
/** Occurs when the remote video state changes.
 ...
 [joinChannel]([WujiRtcEngineKit joinChannelByToken:channelId:info:uid:joinSuccess:]) method until
...
The SDK reports the current video state in this callback.
 ...
 @param engine WujiRtcEngineKit object.
 @param state The local video state, see WujiLocalVideoStreamState. When the state is
WujiLocalVideoStreamStateFailed(3), see the `error` parameter for details.
 @param error The detailed error information of the local video, see WujiLocalVideoStreamError.
 */
- (void)rtcEngine:(WujiRtcEngineKit *_Nonnull)engine
    localVideoStateChange:(WujiLocalVideoStreamState)state
                    error:(WujiLocalVideoStreamError)error;
...
/** Occurs when the local audio state changes.
 ...
 @param elapsed Time elapsed (ms) from the local user calling the [joinChannel]([WujiRtcEngineKit
 joinChannelByToken:channelId:info:uid:joinSuccess:]) method until the SDK triggers this callback.
 */
- (void)rtcEngine:(WujiRtcEngineKit *_Nonnull)engine
...
/** Occurs when the local audio state changes.
 ...
 [WujiAudioLocalError](WujiAudioLocalError).

 @note When the state is WujiAudioLocalStateFailed(3), see the `error` parameter for details.
 */
- (void)rtcEngine:(WujiRtcEngineKit *_Nonnull)engine
    localAudioStateChange:(WujiAudioLocalState)state
                    error:(WujiAudioLocalError)error;
...
If you call [setRemoteSubscribeFallbackOption]([WujiRtcEngineKit setRemoteSubscribeFallbackOption:])
and set `option` as `WujiStreamFallbackOptionAudioOnly`, the SDK triggers this callback when the
...
[remoteVideoStats]([WujiRtcEngineDelegate rtcEngine:remoteVideoStats:]) callback.
...
- (void)rtcEngine:(WujiRtcEngineKit *_Nonnull)engine
           device:(NSString *_Nonnull)deviceId
             type:(WujiMediaDeviceType)deviceType
 ...
 */
- (void)rtcEngine:(WujiRtcEngineKit *_Nonnull)engine
    didAudioRouteChanged:(WujiAudioOutputRouting)routing;
 ...
 **Since:** v3.0.1.
 ...
 Once you enable face detection by calling [enableFaceDetection]([WujiRtcEngineKit
 ...
 **Note**
 ...
 @param faces An WujiFacePositionInfo array, which contains the information of the detected human
 face.

 The number of the WujiFacePositionInfo array depends on the number of human faces detected. If the
 array length is 0, it means that no human face is detected.
 */
- (void)rtcEngine:(WujiRtcEngineKit *_Nonnull)engine
    facePositionDidChangeWidth:(int)width
                 previewHeight:(int)height
                         faces:(NSArray<WujiFacePositionInfo *> *_Nullable)faces;
...
Last mile refers to the connection between the local device and Wuji's edge server. After the app
calls the [enableLastmileTest]([WujiRtcEngineKit enableLastmileTest]) method, the SDK triggers this
...
[startLastmileProbeTest]([WujiRtcEngineKit startLastmileProbeTest:]) method.

 @param engine WujiRtcEngineKit object.
 @param result The uplink and downlink last-mile network probe test result, see
[WujiLastmileProbeResult](WujiLastmileProbeResult).
 */
- (void)rtcEngine:(WujiRtcEngineKit *_Nonnull)engine
    lastmileProbeTestResult:(WujiLastmileProbeResult *_Nonnull)result;

/** Reports the statistics of the uploading local video streams once every two seconds. Same as
 [localVideoStatBlock]([WujiRtcEngineKit localVideoStatBlock:]).

 @param engine WujiRtcEngineKit object.
 @param stats Statistics of the uploading local video streams. See
 [WujiRtcLocalVideoStats](WujiRtcLocalVideoStats).
 */
- (void)rtcEngine:(WujiRtcEngineKit *_Nonnull)engine
    localVideoStats:(WujiRtcLocalVideoStats *_Nonnull)stats;
...
/** Reports the statistics of the local audio stream.
 ...
 [WujiRtcLocalAudioStats](WujiRtcLocalAudioStats).
 */
- (void)rtcEngine:(WujiRtcEngineKit *_Nonnull)engine
    localAudioStats:(WujiRtcLocalAudioStats *_Nonnull)stats;
...
[videoTransportStatsOfUid]([WujiRtcEngineDelegate
...
/** Reports the statistics of the audio stream from each remote user/host.
 ...
 This callback replaces the [audioQualityOfUid]([WujiRtcEngineDelegate
rtcEngine:audioQualityOfUid:quality:delay:lost:]) callback.
...
more about media layer statistics such as the frame loss rate, while the
[audioTransportStatsOfUid]([WujiRtcEngineDelegate
...
You can start an audio mixing file playback by calling the [startAudioMixing]([WujiRtcEngineKit
...
mixing file playback finishes.
 ...
 If the [startAudioMixing]([WujiRtcEngineKit startAudioMixing:loopback:replace:cycle:]) method call
fails, a warning code, WujiWarningCodeAudioMixingOpenError, returns in the
[didOccurWarning]([WujiRtcEngineDelegate rtcEngine:didOccurWarning:]) callback.
...
cannot access the music file URL, the SDK returns `WujiWarningCodeAudioMixingOpenError = 701`.
...
*/
- (void)rtcEngine:(WujiRtcEngineKit *_Nonnull)engine
    localAudioMixingStateDidChanged:(WujiAudioMixingStateCode)state
                          errorCode:(WujiAudioMixingErrorCode)errorCode;

/** Occurs when a remote user starts audio mixing.

 The SDK triggers this callback when a remote user calls the [startAudioMixing]([WujiRtcEngineKit
...
/** Occurs when the local audio effect playback finishes.
 ...
 You can start a local audio effect playback by calling the [playEffect]([WujiRtcEngineKit
...
/** Occurs when the CDN live streaming settings are updated.
 ...
 When the `LiveTranscoding` class in the [setLiveTranscoding]([WujiRtcEngineKit
 ...
 **DEPRECATED** from v3.0.0. Use `WujiAudioRemoteStateStarting(1)` in the
 [remoteAudioStateChangedOfUid]([WujiRtcEngineDelegate
 ...
 **DEPRECATED** from v3.0.0. Use `WujiAudioRemoteStateDecoding(2)` in the
 [remoteAudioStateChangedOfUid]([WujiRtcEngineDelegate
 ...
 an interruption include:
     ...
     - The remote user leaves channel.
     - The remote user drops offline.
     - The remote user calls the [muteLocalAudioStream]([WujiRtcEngineKit muteLocalAudioStream:])
 method to stop sending the local audio stream.
     - The remote user calls the [disableAudio]([WujiRtcEngineKit disableAudio]) method to disable
 audio.
 ...
 **DEPRECATED** from v3.0.0. Use the [remoteAudioStateChangedOfUid]([WujiRtcEngineDelegate
 ...
 calling the [muteLocalAudioStream]([WujiRtcEngineKit muteLocalAudioStream:]) method.
...
/** Reports the result of calling the [addPublishStreamUrl]([WujiRtcEngineKit
 ...
 - WujiErrorCodeInvalidArgument(2): Invalid argument used. If, for example, you do not call the
 [setLiveTranscoding]([WujiRtcEngineKit setLiveTranscoding:]) method to configure
 WujiLiveTranscoding before calling the [addPublishStreamUrl]([WujiRtcEngineKit
 ...
 - WujiErrorCodeAbort(20): The SDK disconnects from the CDN live streaming server, and the CDN live
 streaming stops.
 - WujiErrorCodeResourceLimited(22): The backend system does not have enough resources for the CDN
 live streaming.
 - WujiErrorCodeEncryptedStreamNotAllowedPublish(130): You cannot publish an encrypted stream.
 - WujiErrorCodePublishStreamCDNError(151): CDN related errors. Remove the original URL address and
 add a new one by calling the [removePublishStreamUrl]([WujiRtcEngineKit removePublishStreamUrl:])
 and [addPublishStreamUrl]([WujiRtcEngineKit addPublishStreamUrl:transcodingEnabled:]) methods.
 - WujiErrorCodePublishStreamNumReachLimit(152): The host publishes more than 10 URLs. Delete the
 unnecessary URLs before adding new ones.
 - WujiErrorCodePublishStreamNotAuthorized(153): The host manipulates other hosts' URLs. Check your
 app logic.
 - WujiErrorCodePublishStreamInternalServerError(154): An error occurs in Wuji's streaming server.
 Call the [addPublishStreamUrl]([WujiRtcEngineKit addPublishStreamUrl:transcodingEnabled:]) method
 to publish the streaming again.
 - WujiErrorCodePublishStreamFormatNotSuppported(156): The format of the RTMP stream URL is not
 supported. Check whether the URL format is correct.
 */
- (void)rtcEngine:(WujiRtcEngineKit *_Nonnull)engine
    streamPublishedWithUrl:(NSString *_Nonnull)url
                 errorCode:(WujiErrorCode)errorCode;

/** Reports the result of calling the [removePublishStreamUrl]([WujiRtcEngineKit
 ...
 **DEPRECATED** from v2.9.0. Use the [remoteAudioStats]([WujiRtcEngineDelegate
 ...
 **DEPRECATED** from v2.9.0. Use the [remoteVideoStats]([WujiRtcEngineDelegate
 ...
 **DEPRECATED** from v2.9.0. This callback is deprecated and replaced by the
 [remoteVideoStateChangedOfUid]([WujiRtcEngineDelegate
 rtcEngine:remoteVideoStateChangedOfUid:state:reason:elapsed:]) callback with the following
 parameters:
 ...
 the [enableVideo]([WujiRtcEngineKit enableVideo]) or [disableVideo]([WujiRtcEngineKit
 disableVideo]) method.
 ...
 **DEPRECATED** from v2.9.0. Use WujiVideoRemoteStateStarting(1) or WujiVideoRemoteStateDecoding(2)
 in the [remoteVideoStateChangedOfUid]([WujiRtcEngineDelegate
 ...
 **DEPRECATED** from v2.9.0. Use WujiAudioLocalStateStopped(0) or WujiAudioLocalStateRecording(1) in
 the [localAudioStateChange]([WujiRtcEngineDelegate rtcEngine:localAudioStateChange:error:])
 callback instead.

 The SDK triggers this callback when the local user resumes or stops capturing the local audio
 stream by calling the [enableLocalAudio]([WujiRtcEngineKit enableLocalAudio:]) method.
...
**DEPRECATED** from v2.3.2. Use the [connectionChangedToState]([WujiRtcEngineDelegate
...
This callback is different from [rtcEngineConnectionDidLost]([WujiRtcEngineDelegate
...
**DEPRECATED** from v2.3.2. Use [connectionChangedToState]([WujiRtcEngineDelegate
...
**DEPRECATED** from v2.3.2. Use [remoteAudioStats]([WujiRtcEngineDelegate
...
- (void)rtcEngine:(WujiRtcEngineKit *_Nonnull)engine
    audioQualityOfUid:(NSUInteger)uid
              quality:(WujiNetworkQuality)quality
                delay:(NSUInteger)delay
                 lost:(NSUInteger)lost;

/** Occurs when the camera turns on and is ready to capture video.

**DEPRECATED** from v2.4.1. Use WujiLocalVideoStreamStateCapturing(1) in the `state` parameter of
[localVideoStateChange]([WujiRtcEngineDelegate rtcEngine:localVideoStateChange:error:]) instead.
...
**DEPRECATED** from v2.4.1. Use WujiLocalVideoStreamStateStopped(0) in the `state` parameter of
[localVideoStateChange]([WujiRtcEngineDelegate rtcEngine:localVideoStateChange:error:]) instead
...
- (void)rtcEngine:(WujiRtcEngineKit *_Nonnull)engine
    capturedSoundLevelInfoUpdate:(WujiSoundLevelInfo *_Nullable)soundLevelInfo;
...
- (void)rtcEngine:(WujiRtcEngineKit *_Nonnull)engine
    remoteSoundLevelInfoUpdate:
        (NSDictionary<NSString *, WujiSoundLevelInfo *> *_Nullable)soundLevelInfos;
...
/** The WujiRtcEngineKit class provides all methods invoked by your app.
 ...
 WujiRtcEngineKit is the basic interface class of the SDK. Creating an WujiRtcEngineKit object and
...
/** Creates an WujiRtcEngineKit instance.
  ...
  Unless otherwise specified, all the methods provided by the WujiRtcEngineKit instance are executed
 asynchronously. Wuji recommends calling these methods in the same thread.

  **Note:**

  - You must create an WujiRtcEngineKit instance before calling any other method.
  - You can create an WujiRtcEngineKit instance either by calling this method or by calling
 [sharedEngineWithConfig]([WujiRtcEngineKit sharedEngineWithConfig:delegate:]). The difference
 ...
 @param appId    The App ID issued to you by Wuji. See [How to get the App
 ID](https://docs.wuji.io/en/Wuji%20Platform/token#get-an-app-id). Only users in apps with the same
 App ID can join the same channel and communicate with each other. Use an App ID to create only one
 WujiRtcEngineKit instance. To change your App ID, call [destroy]([WujiRtcEngineKit destroy]) to
 destroy the current WujiRtcEngineKit instance and then call create to create an WujiRtcEngineKit
 ...
 - The error code, if this method call fails.
    ...
    - `WujiErrorCodeInvalidAppId(-101)`: The App ID is invalid. Check if your App ID is in the
 correct format.
 */
...
/** Creates an WujiRtcEngineKit instance.
  ...
  **Note:**
  ...
  - You can create an WujiRtcEngineKit instance either by calling this method or by calling
 [sharedEngineWithAppId]([WujiRtcEngineKit sharedEngineWithAppId:delegate:]). The difference between
 `sharedEngineWithAppId` and this method is that this method enables you to specify the connection
 area.
  - The Wuji RTC Native SDK supports creating only one WujiRtcEngineKit instance for an app for now.

  @param config    Configurations for the WujiRtcEngineKit instance. For details, see
 WujiRtcEngineConfig.
  @param delegate WujiRtcEngineDelegate.
...
/** Destroys the WujiRtcEngineKit instance and releases all resources used by the SDK.
 ...
 Once the app calls this method to release the created WujiRtcEngineKit instance, no other methods
 in the SDK can be used and no callbacks can occur. To start communications again, initialize
 [sharedEngineWithappId]([WujiRtcEngineKit sharedEngineWithAppId:delegate:]) to establish a new
 WujiRtcEngineKit instance.

 **Note:**

 - Call this method in the subthread.
 - This method call is synchronous. The result returns after the WujiRtcEngineKit object resources
...
The WujiRtcEngineKit differentiates channel profiles and applies optimization algorithms
...
* Call this method before calling [joinChannelByToken]([WujiRtcEngineKit
joinChannelByToken:channelId:info:uid:joinSuccess:]). You cannot set the channel profile once you
have joined the channel.

 @param profile The channel profile of the WujiRtcEngineKit:
[WujiChannelProfile](WujiChannelProfile).
...
- The local client: [didClientRoleChanged]([WujiRtcEngineDelegate
rtcEngine:didClientRoleChanged:newRole:])
- Remote clients: [didJoinedOfUid]([WujiRtcEngineDelegate rtcEngine:didJoinedOfUid:elapsed:]) or
[didOfflineOfUid(WujiUserOfflineReasonBecomeAudience)]([WujiRtcEngineDelegate
...
You must call the [leaveChannel]([WujiRtcEngineKit leaveChannel:]) method to exit the current call
...
If the [joinChannelByToken]([WujiRtcEngineKit joinChannelByToken:channelId:info:uid:joinSuccess:])
method call succeeds, the SDK triggers`joinSuccessBlock`. If you implement both `joinSuccessBlock`
and [didJoinChannel]([WujiRtcEngineDelegate rtcEngine:didJoinChannel:withUid:elapsed:]),
`joinSuccessBlock` takes higher priority than [didJoinChannel]([WujiRtcEngineDelegate
rtcEngine:didJoinChannel:withUid:elapsed:]).

We recommend you set `joinSuccessBlock` as nil to use [didJoinChannel]([WujiRtcEngineDelegate
rtcEngine:didJoinChannel:withUid:elapsed:]).

A successful joinChannel method call triggers the following callbacks:

- The local client: [didJoinChannel]([WujiRtcEngineDelegate
rtcEngine:didJoinChannel:withUid:elapsed:])
- The remote client: [didJoinedOfUid]([WujiRtcEngineDelegate rtcEngine:didJoinedOfUid:elapsed:]), if
the user joining the channel is in the Communication profile, or is a BROADCASTER in the Live
Broadcast profile.

When the connection between the client and Wuji's server is interrupted due to poor network
conditions, the SDK tries reconnecting to the server. When the local client successfully rejoins the
channel, the SDK triggers the [didRejoinChannel]([WujiRtcEngineDelegate
...
token](https://docs.wuji.io/en/Interactive%20Broadcast/token_server_cpp?platform=CPP).
 @param channelId Unique channel name for the WujiRTC session in the string format. The string
...
[didJoinChannel]([WujiRtcEngineDelegate rtcEngine:didJoinChannel:withUid:elapsed:]). If
`joinSuccessBlock` is nil, the SDK triggers the [didJoinChannel]([WujiRtcEngineDelegate
...
- On the local client: [didRegisteredLocalUser]([WujiRtcEngineDelegate
rtcEngine:didRegisteredLocalUser:withUid:]) and [didJoinChannel]([WujiRtcEngineDelegate
rtcEngine:didJoinChannel:withUid:elapsed:]).
- On the remote client: [didJoinedOfUid]([WujiRtcEngineDelegate rtcEngine:didJoinedOfUid:elapsed:])
and [didUpdatedUserInfo]([WujiRtcEngineDelegate rtcEngine:didUpdatedUserInfo:withUid:]), if the user
...
same applies to the user account. If a user joins the channel with the Wuji Web SDK, ensure that the
...
see [Get a temporary
token](https://docs.wuji.io/en/Voice/token?platform=All%20Platforms#get-a-temporary-token).
- For high-security requirements: Set it as the token generated at your server. For details, see
[Get a token](https://docs.wuji.io/en/Voice/token?platform=All%20Platforms#get-a-token).
...
[didRegisteredLocalUser]([WujiRtcEngineDelegate rtcEngine:didRegisteredLocalUser:withUid:]) callback
on the local client, reporting the user ID and user account of the local user.

To join a channel with a user account, you can choose either of the following:

- Call the [registerLocalUserAccount]([WujiRtcEngineKit registerLocalUserAccount:appId:]) method to
create a user account, and then the [joinChannelByUserAccount]([WujiRtcEngineKit
joinChannelByUserAccount:token:channelId:joinSuccess:]) method to join the channel.
- Call the [joinChannelByUserAccount]([WujiRtcEngineKit
joinChannelByUserAccount:token:channelId:joinSuccess:]) method to join the channel.
...
The same applies to the user account. If a user joins the channel with the Wuji Web SDK, ensure that
...
After a remote user joins the channel, the SDK gets the user ID and user account of the remote user,
caches them in a mapping table object (`WujiUserInfo`), and triggers the
[didUpdatedUserInfo]([WujiRtcEngineDelegate rtcEngine:didUpdatedUserInfo:withUid:]) callback on the
local client.

After receiving the [didUpdatedUserInfo]([WujiRtcEngineDelegate
...
@return An [WujiUserInfo](WujiUserInfo) object that contains the user account and user ID of the
user.
*/
...
them in a mapping table object (`WujiUserInfo`), and triggers the
[didUpdatedUserInfo]([WujiRtcEngineDelegate rtcEngine:didUpdatedUserInfo:withUid:]) callback on the
local client.
...
/** Switches to a different channel.
 ...
 [didLeaveChannelWithStats]([WujiRtcEngineDelegate rtcEngine:didLeaveChannelWithStats:]) and
 [didJoinChannel]([WujiRtcEngineDelegate rtcEngine:didJoinChannel:withUid:elapsed:]) callbacks are
 ...
 token](https://docs.wuji.io/en/Wuji%20Platform/token?platform=All%20Platforms#get-a-token).
 @param channelId Unique channel name for the WujiRTC session in the string format. The string
 length must be less than 64 bytes. Supported character scopes are:
...
- The local client: [didLeaveChannelWithStats]([WujiRtcEngineDelegate
rtcEngine:didLeaveChannelWithStats:])
- The remote client: [didOfflineOfUid(WujiUserOfflineReasonBecomeAudience)]([WujiRtcEngineDelegate
...
interrupts, and the SDK does not trigger the [didLeaveChannelWithStats]([WujiRtcEngineDelegate
...
`WujiAudioSessionOperationRestrictionDeactivateSession` so that when you call the
[leaveChannel]([WujiRtcEngineKit leaveChannel:]) method, the SDK does not deactivate the audio
session.

 @param leaveChannelBlock This callback indicates that a user leaves a channel, and provides the
statistics of the call. See [WujiChannelStats](WujiChannelStats).
...
The `token` expires after a period of time once the token schema is enabled when:
  ...
  - The SDK triggers the [tokenPrivilegeWillExpire]([WujiRtcEngineDelegate
rtcEngine:tokenPrivilegeWillExpire:]) callback, or
  - [connectionChangedToState]([WujiRtcEngineDelegate rtcEngine:connectionChangedToState:reason:])
reports WujiConnectionChangedTokenExpired(9) in the`reason` parameter.

 **Note:**

 Wuji recommends using the [rtcEngineRequestToken]([WujiRtcEngineDelegate rtcEngineRequestToken:])
callback to report the WujiErrorCodeTokenExpired(-109) error, not using the
[didOccurError]([WujiRtcEngineDelegate rtcEngine:didOccurError:]) callback.
...
/** Starts to relay media streams across channels.
 ...
 [channelMediaRelayStateDidChange]([WujiRtcEngineDelegate
 rtcEngine:channelMediaRelayStateDidChange:error:]) and
 [didReceiveChannelMediaRelayEvent]([WujiRtcEngineDelegate
 ...
 **Note**
 ...
 - Call this method after the [joinChannel]([WujiRtcEngineKit
 joinChannelByToken:channelId:info:uid:joinSuccess:]) method.
 ...
 [stopChannelMediaRelay]([WujiRtcEngineKit stopChannelMediaRelay]) method to quit the current relay.
 ...
 **Note**
 ...
 - Call this method after the [startChannelMediaRelay]([WujiRtcEngineKit startChannelMediaRelay:])
...
/** Stops the media stream relay.
 ...
 WujiChannelMediaRelayErrorServerNoResponse(2) or
 WujiChannelMediaRelayEventUpdateDestinationChannelRefused(8) state code. You can leave the channel
 by calling the [leaveChannel]([WujiRtcEngineKit leaveChannel:]) method, and the media stream relay
 automatically stops.
...
[leaveChannel]([WujiRtcEngineKit leaveChannel:]) method. You can call this method either before or
after joining a channel.
- This method resets the internal engine and takes some time to take effect. Wuji recommends using
the following API methods to control the audio engine modules separately:

    * [enableLocalAudio]([WujiRtcEngineKit enableLocalAudio:]): Whether to enable the microphone to
create the local audio stream.
    * [muteLocalAudioStream]([WujiRtcEngineKit muteLocalAudioStream:]): Whether to publish the local
audio stream.
    * [muteRemoteAudioStream]([WujiRtcEngineKit muteRemoteAudioStream:mute:]): Whether to subscribe
to and play the remote audio stream.
    * [muteAllRemoteAudioStreams]([WujiRtcEngineKit muteAllRemoteAudioStreams:]): Whether to
 ...
 * You must call this method before the [joinChannelByToken]([WujiRtcEngineKit
joinChannelByToken:channelId:info:uid:joinSuccess:]) method.
...
`WujiAudioProfileMusicHighQuality(4)` and `scenario` as `WujiAudioScenarioGameStreaming(3)`. For
...
[WujiAudioProfile](WujiAudioProfile).
 @param scenario Sets the audio application scenario. See [WujiAudioScenario](WujiAudioScenario).
...
* < 0: Failure.
 */
- (int)setAudioProfile:(WujiAudioProfile)profile scenario:(WujiAudioScenario)scenario;
 ...
 * 400: (Maximum) Four times the original volume with signal clipping protection.
 <p>**Note:**<p>To avoid echoes and improve call quality, Wuji recommends setting the value of
volume between 0 and 100. If you need to set the value higher than 100, contact support@wuji.io
first.</p>
 ...
 **Note**
 ...
 [adjustAudioMixingVolume]([WujiRtcEngineKit adjustAudioMixingVolume:]), and set `volume` as 0.
 ...
 * &gt; 0: The time interval (ms) between two consecutive volume indications. Wuji recommends
setting `interval` &ge; 200 ms. Once this method is enabled, the SDK returns the volume indications
at the set time interval in the [reportAudioVolumeIndicationOfSpeakers]([WujiRtcEngineDelegate
...
the `vad` parameter of the [reportAudioVolumeIndicationOfSpeakers]([WujiRtcEngineDelegate
...
`vad` parameter of the [reportAudioVolumeIndicationOfSpeakers]([WujiRtcEngineDelegate
...
The SDK triggers the [didMicrophoneEnabled]([WujiRtcEngineDelegate rtcEngine:didMicrophoneEnabled:])
callback once the local audio module is disabled or re-enabled.

**Note:**

This method is different from the [muteLocalAudioStream]([WujiRtcEngineKit muteLocalAudioStream:])
method:

  - [enableLocalAudio]([WujiRtcEngineKit enableLocalAudio:]): Disables/Re-enables the local audio
...
`enableLocalAudio` method, the local user may hear a pause in the remote audio playback.
  - [muteLocalAudioStream]([WujiRtcEngineKit muteLocalAudioStream:]): Sends/Stops sending the local
audio stream.
...
method call triggers the [didAudioMuted]([WujiRtcEngineDelegate rtcEngine:didAudioMuted:byUid:])
...
any ongoing recording.
 - If you call [setChannelProfile]([WujiRtcEngineKit setChannelProfile:]) after this method, the SDK
 ...
 **Note:**
 ...
 If you call the [muteAllRemoteAudioStreams]([WujiRtcEngineKit muteAllRemoteAudioStreams:]) method
...
A successful enableVideo method call triggers the [didVideoEnabled(YES)]([WujiRtcEngineDelegate
...
- This method affects the internal engine and can be called after the
[leaveChannel]([WujiRtcEngineKit leaveChannel:]) method.
- This method resets the internal engine and takes some time to take effect. Wuji recommends using
the following API methods to control the video engine modules separately:

    * [enableLocalVideo]([WujiRtcEngineKit enableLocalVideo:]): Whether to enable the camera to
create the local video stream.
    * [muteLocalVideoStream]([WujiRtcEngineKit muteLocalVideoStream:]): Whether to publish the local
video stream.
    * [muteRemoteVideoStream]([WujiRtcEngineKit muteRemoteVideoStream:mute:]): Whether to subscribe
to and play the remote video stream.
    * [muteAllRemoteVideoStreams]([WujiRtcEngineKit muteAllRemoteVideoStreams:]): Whether to
...
[enableVideo]([WujiRtcEngineKit enableVideo]) method.

   A successful disableVideo method call triggers the [didVideoEnabled(NO)]([WujiRtcEngineDelegate
rtcEngine:didVideoEnabled:byUid:]) callback on the remote client.
...
modes of the video view. To unbind the `view`, set the `view` in WujiRtcVideoCanvas to `nil`.

 **Note**

 To update the rendering or mirror mode of the local video view during a call, use
[setLocalRenderMode]([WujiRtcEngineKit setLocalRenderMode:mirrorMode:]).
...
[userJoinedBlock]([WujiRtcEngineKit userJoinedBlock:]) callback.

 If the Video Recording function is enabled, the Video Recording Service joins the channel as a
dummy client, causing other clients to also receive the [didJoinedOfUid]([WujiRtcEngineDelegate
...
[firstRemoteVideoDecodedOfUid]([WujiRtcEngineDelegate
rtcEngine:firstRemoteVideoDecodedOfUid:size:elapsed:]) callback.

 To unbind the remote user from the view, set the `view` in WujiRtcVideoCanvas as nil. Once the
...
[setRemoteRenderMode]([WujiRtcEngineKit setRemoteRenderMode:renderMode:mirrorMode:]).
 ...
 **Note**
 ...
 - Ensure that you have called [setupLocalVideo]([WujiRtcEngineKit setupLocalVideo:]) to initialize
...
Before calling this method, you must:
 ...
 - Call the [setupLocalVideo]([WujiRtcEngineKit setupLocalVideo:]) method to set up the local
...
[leaveChannel]([WujiRtcEngineKit leaveChannel:]) method, the local video preview remains until you
...
remote video stream.
 ...
 After you call the [enableVideo]([WujiRtcEngineKit enableVideo]) method, the local video capturer
is enabled by default. You can call [enableLocalVideo(NO)]([WujiRtcEngineKit enableLocalVideo:]) to
disable the local video capturer. If you want to re-enable it, call
[enableLocalVideo(YES)]([WujiRtcEngineKit enableLocalVideo:]).

 After the local video capturer is successfully disabled or re-enabled, the SDK triggers the
[didLocalVideoEnabled]([WujiRtcEngineDelegate rtcEngine:didLocalVideoEnabled:byUid:]) callback on
the remote client.
...
/** Sends/Stops sending the local video stream.
 ...
 A successful `muteLocalVideoStream` method call triggers the [didVideoMuted]([WujiRtcEngineDelegate
...
[enableLocalVideo]([WujiRtcEngineKit enableLocalVideo:]) method which controls the sending of local
video streams.
 - If you call [setChannelProfile]([WujiRtcEngineKit setChannelProfile:]) after this method, the SDK
...
**Note:**
 ...
 If you call the [muteAllRemoteVideoStreams]([WujiRtcEngineKit muteAllRemoteVideoStreams:]) method
 ...
 * Call this method before calling the [joinChannelByToken]([WujiRtcEngineKit
joinChannelByToken:channelId:info:uid:joinSuccess:]) method.
...
SDK returns the [didAudioRouteChanged]([WujiRtcEngineDelegate rtcEngine:didAudioRouteChanged:])
callback, indicating that the audio route changes.

 **Note:**

 * Ensure that you have successfully called the [joinChannelByToken]([WujiRtcEngineKit
...
8k, and 16k Hz. See WujiAudioEqualizationBandFrequency.
...
* -1: Failure.
*/
- (int)setLocalVoiceEqualizationOfBandFrequency:(WujiAudioEqualizationBandFrequency)bandFrequency
                                       withGain:(NSInteger)gain;

/** Sets the local voice reverberation.

 v2.4.0 adds the [setLocalVoiceReverbPreset]([WujiRtcEngineKit setLocalVoiceReverbPreset:]) method,
...
set the local reverberation effect, such as Popular, R&B, Rock, Hip-hop, and more.
 ...
 @param value      Sets the effect of the reverberation type. See WujiAudioReverbType for the value
range.
...
| | :----------------------- | :----------------------------------------------------------- |
:---------------- | | WujiAudioVoiceChanger*        | Changes the local voice to an old man, a
little boy, or the Hulk. | Voice talk        | | WujiAudioVoiceBeauty*         | Beautifies the
local voice by making it sound more vigorous, resounding, or adding spacial resonance. | Voice
talkSinging | | WujiAudioGeneralBeautyVoice* | Adds gender-based beautification effect to the local
...
- To achieve better voice effect quality, Wuji recommends setting the `profile` parameter in
[setAudioProfile]([WujiRtcEngineKit setAudioProfile:scenario:]) as
`WujiAudioProfileMusicHighQuality(4)` or `WujiAudioProfileMusicHighQualityStereo(5)`.
- This method works best with the human voice, and Wuji does not recommend using it for audio
containing music and a human voice.
- Do not use this method with [setLocalVoiceReverbPreset]([WujiRtcEngineKit
...
@param voiceChanger The local voice changer option. The default value is `WujiAudioVoiceChangerOff`,
which means the original voice. See details in WujiAudioVoiceChanger. <br>Gender-based beatification
effect works best only when assigned a proper gender: <li>For male:
WujiAudioGeneralBeautyVoiceMaleMagnetic.<li>For female: WujiAudioGeneralBeautyVoiceFemaleFresh or
WujiAudioGeneralBeautyVoiceFemaleVitality.</li> <br>Failure to do so can lead to voice
distortion.
...
- When calling this method with enumerations that begin with `WujiAudioReverbPresetFx`, ensure that
you set `profile` in [setAudioProfile]([WujiRtcEngineKit setAudioProfile:scenario:]) as
`WujiAudioProfileMusicHighQuality(4)` or `WujiAudioProfileMusicHighQualityStereo(5)`. Otherwise,
this method call does not take effect.
- When calling this method with `WujiAudioReverbPresetVirtualStereo`, Wuji recommends setting the
`profile` parameter in `setAudioProfile` as `WujiAudioProfileMusicHighQualityStereo(5)`.
- This method works best with the human voice, and Wuji does not recommend using it for audio
containing music and a human voice.
- Do not use this method with [setLocalVoiceChanger]([WujiRtcEngineKit setLocalVoiceChanger:]),
...
`WujiAudioReverbPresetOff`, which means the original voice. See details in
WujiAudioReverbPreset.<br>**Note**<br>To achieve better voice effects, Wuji recommends the
enumeration whose name begins with `WujiAudioReverbPresetFx`.
...
If you need to use the [setRemoteVoicePosition]([WujiRtcEngineKit setRemoteVoicePosition:pan:gain:])
...
[localAudioMixingStateDidChanged]([WujiRtcEngineDelegate
rtcEngine:localAudioMixingStateDidChanged:errorCode:])(WujiAudioMixingStatePlaying) callback on the
local client.

 When the audio mixing file playback finishes, the SDK triggers the
[localAudioMixingStateDidChanged]([WujiRtcEngineDelegate
rtcEngine:localAudioMixingStateDidChanged:errorCode:])(WujiAudioMixingStateStopped) callback on the
local client.
...
[playEffect]([WujiRtcEngineKit playEffect:filePath:loopCount:pitch:pan:gain:publish:]) method.
 ...
 **Since:** v3.0.1.
 ...
 @note Call this method after calling [startAudioMixing]([WujiRtcEngineKit
 ...
 **Since:** v3.0.1.
 ...
 [facePositionDidChangeWidth]([WujiRtcEngineDelegate
...
[rtcEngineDidAudioEffectFinish]([WujiRtcEngineDelegate rtcEngineDidAudioEffectFinish:soundId:])
callback.
 ...
 * NO: The played audio effect is not published to the Wuji Cloud and the remote users cannot hear
it.
...
/** Preloads a specified audio effect file into the memory.
 ...
 To ensure smooth communication, limit the size of the audio effect file. Wuji recommends using this
method to preload the audio effect before calling the [joinChannelByToken]([WujiRtcEngineKit
joinChannelByToken:channelId:info:uid:joinSuccess:]) method.
...
///
/// After starting monitoring, you can receive local audio sound level via [capturedSoundLevelUpdate]([WujiRtcEngineKit rtcEngine:capturedSoundLevelUpdate:]) callback, and receive remote audio sound level via [remoteSoundLevelUpdate]([WujiRtcEngineKit rtcEngine:remoteSoundLevelUpdate:]) callback.
/// Before entering the room, you can call [startPreview]([WujiRtcEngineKit startPreview]) with this function and combine it with [capturedSoundLevelUpdate]([WujiRtcEngineKit rtcEngine:capturedSoundLevelUpdate:]) callback to determine whether the audio device is working properly.
/// [capturedSoundLevelUpdate]([WujiRtcEngineKit rtcEngine:capturedSoundLevelUpdate:]) and [remoteSoundLevelUpdate]([WujiRtcEngineKit rtcEngine:remoteSoundLevelUpdate:]) callback notification period is 100 ms.
//  @return * 0: Success.
//  * < 0: Failure.
...
/// After starting monitoring, you can receive local audio sound level via [capturedSoundLevelUpdate]([WujiRtcEngineKit rtcEngine:capturedSoundLevelUpdate:]) callback, and receive remote audio sound level via [remoteSoundLevelUpdate]([WujiRtcEngineKit rtcEngine:remoteSoundLevelUpdate:]) callback.
/// Before entering the room, you can call [startPreview]([WujiRtcEngineKit startPreview]) with this function and combine it with [capturedSoundLevelUpdate]([WujiRtcEngineKit rtcEngine:capturedSoundLevelUpdate:]) callback to determine whether the audio device is working properly.
/// [capturedSoundLevelUpdate]([WujiRtcEngineKit rtcEngine:capturedSoundLevelUpdate:]) and [remoteSoundLevelUpdate]([WujiRtcEngineKit rtcEngine:remoteSoundLevelUpdate:]) callback notification period is the value set by the parameter.
/// If you want to use advanced feature of sound level, please use the function of the same name (the parameter type is WujiSoundLevelConfig) instead.
///
...
//  @return * 0: Success.
//  * < 0: Failure.
- (int)startSoundLevelMonitorWithConfig:(WujiSoundLevelConfig * _Nonnull)config;
...
///
/// After starting monitoring, you can receive local audio spectrum via [capturedAudioSpectrumUpdate]([WujiRtcEngineKit rtcEngine:capturedAudioSpectrumUpdate:]) callback, and receive remote audio spectrum via [remoteAudioSpectrumUpdate]([WujiRtcEngineKit rtcEngine:remoteAudioSpectrumUpdate:]) callback.
/// [capturedAudioSpectrumUpdate]([WujiRtcEngineKit rtcEngine:capturedAudioSpectrumUpdate:]) and [remoteAudioSpectrumUpdate]([WujiRtcEngineKit rtcEngine:remoteAudioSpectrumUpdate:]) callback notification period is 100 ms.
//  @return * 0: Success.
//  * < 0: Failure.
...
///
/// After starting monitoring, you can receive local audio spectrum via [capturedAudioSpectrumUpdate]([WujiRtcEngineKit rtcEngine:capturedAudioSpectrumUpdate:]) callback, and receive remote audio spectrum via [remoteAudioSpectrumUpdate]([WujiRtcEngineKit rtcEngine:remoteAudioSpectrumUpdate:]) callback.
/// [capturedAudioSpectrumUpdate]([WujiRtcEngineKit rtcEngine:capturedAudioSpectrumUpdate:]) and [remoteAudioSpectrumUpdate]([WujiRtcEngineKit rtcEngine:remoteAudioSpectrumUpdate:]) callback notification period is the value set by the parameter.
///
 ...
 **Note**
 ...
 - This method is usually called after the [joinChannelByToken]([WujiRtcEngineKit
joinChannelByToken:channelId:info:uid:joinSuccess:]) method. The recording automatically stops when
you call the [leaveChannel]([WujiRtcEngineKit leaveChannel:]) method.
 - For better recording effects, set `quality` as WujiAudioRecordingQualityMedium or
WujiAudioRecordingQualityHigh when `sampleRate` is 44100 Hz or 48000 Hz.
 ...
 **Note:**
 ...
 You can call this method before calling the [leaveChannel]([WujiRtcEngineKit leaveChannel:])
method, else the recording automatically stops when you call the [leaveChannel]([WujiRtcEngineKit
leaveChannel:]) method.
...
method, please use a virtual sound card and pass its name to the `deviceName` parameter. Wuji has
 ...
 **Note:**
 ...
 [WujiAudioSessionOperationRestriction](WujiAudioSessionOperationRestriction).
...
/** Stops the audio call test.
 ...
 @return * 0: Success.
* < 0: Failure. For example, WujiErrorCodeRefused(-5)：Failed to stop the echo test. The echo test
may not be running.
 */
- (int)stopEchoTest;
...
not recommend calling this method together with [startLastmileProbeTest]([WujiRtcEngineKit
startLastmileProbeTest:]).

 Call the [disableLastmileTest](disableLastmileTest) method to disable this test after receiving the
[lastmileQuality]([WujiRtcEngineDelegate rtcEngine:lastmileQuality:]) callback, and before the user
joins the channel or switches the user role.

 **Note:**

 - Do not call any other methods before receiving the [lastmileQuality]([WujiRtcEngineDelegate
...
[setVideoEncoderConfiguration]([WujiRtcEngineKit setVideoEncoderConfiguration:]) method. After you
...
- [lastmileQuality]([WujiRtcEngineDelegate rtcEngine:lastmileQuality:]): the SDK triggers this
...
- [lastmileProbeResult]([WujiRtcEngineDelegate rtcEngine:lastmileProbeTestResult:])the SDK triggers
...
recommend calling this method together with [enableLastmileTest]([WujiRtcEngineKit
enableLastmileTest]).
- Do not call other methods before receiving the [lastmileQuality]([WujiRtcEngineDelegate
rtcEngine:lastmileQuality:]) and [lastmileProbeResult]([WujiRtcEngineDelegate
...
[WujiLastmileProbeConfig](WujiLastmileProbeConfig).
...
publish streams. To use an external video source, call WujiVideoSourceProtocol to set the custom
...
external video renderer, call WujiVideoSinkProtocol to set the custom local video renderer and then
...
/** Sets the remote video renderer.
 ...
 renderer to render the video. To use an external video renderer, call WujiVideoSinkProtocol to set
...
/** Enables the external audio sink.
 ...
 [pullPlaybackAudioFrameRawData]([WujiRtcEngineKit pullPlaybackAudioFrameRawData:lengthInByte:]) /
 [pullPlaybackAudioFrameSampleBufferByLengthInByte]([WujiRtcEngineKit
...
/** Pulls the remote audio data in the RawData format.
 ...
 Before calling this method, call the [enableExternalAudioSink]([WujiRtcEngineKit
 ...
 **Note**
 ...
 - Once you call the [pullPlaybackAudioFrameRawData]([WujiRtcEngineKit
 ...
 the [enableExternalAudioSink]([WujiRtcEngineKit enableExternalAudioSink:channels:]) method:
 ...
 **Note**
 ...
 - Once you call the [pullPlaybackAudioFrameSampleBufferByLengthInByte]([WujiRtcEngineKit
 ...
 [enableExternalAudioSink]([WujiRtcEngineKit enableExternalAudioSink:channels:]) method:
...
/** Configures the external video source.
 ...
 If an external video source is used, call this method before the [enableVideo]([WujiRtcEngineKit
 enableVideo]) or [startPreview]([WujiRtcEngineKit startPreview]) method.
...
This method pushes the video frame using the WujiVideoFrame class and passes the video frame to the
SDK with the `format` parameter found in WujiVideoFrame. Call the
...
See [Raw Audio
Data](https://docs.wuji.io/en/Interactive%20Broadcast/raw_data_audio_apple?platform=iOS).
...
WujiAudioRawFrameOperationMode.
...
/** Adds a watermark image to the local video.
 ...
 can see and capture it. Wuji supports adding only one watermark image onto the local video, and the
 newly watermark image replaces the previous one.

 The watermark position depends on the settings in the
 [setVideoEncoderConfiguration]([WujiRtcEngineKit setVideoEncoderConfiguration:]) method:

 - If the orientation mode of the encoding video is WujiVideoOutputOrientationModeFixedLandscape, or
 the landscape mode in WujiVideoOutputOrientationModeAdaptative, the watermark uses the landscape
 orientation.
 - If the orientation mode of the encoding video is WujiVideoOutputOrientationModeFixedPortrait, or
 the portrait mode in WujiVideoOutputOrientationModeAdaptative, the watermark uses the portrait
 orientation.
 - When setting the watermark position, the region must be less than the dimensions set in the
 [setVideoEncoderConfiguration]([WujiRtcEngineKit setVideoEncoderConfiguration:]) method. Otherwise,
 the watermark image will be cropped.

 **Note**

 - Ensure that you have called the [enableVideo]([WujiRtcEngineKit enableVideo]) method to enable
 ...
 [setLiveTranscoding]([WujiRtcEngineKit setLiveTranscoding:]) method.
 ...
 - If you have enabled the local video preview by calling the [startPreview]([WujiRtcEngineKit
 ...
 mirrored. To avoid mirroring the watermark, Wuji recommends that you do not use the mirror and
 ...
 the Wuji Native SDK cannot recognize the image.
...
/** Removes the watermark image from the video stream added by [addVideoWatermark]([WujiRtcEngineKit
...
The default setting for `option` is `WujiStreamFallbackOptionDisabled`, where there is no fallback
...
back to the video, the SDK triggers the [didLocalPublishFallbackToAudioOnly]([WujiRtcEngineDelegate
rtcEngine:didLocalPublishFallbackToAudioOnly:]) callback.

 **Note:**

 Wuji does not recommend using this method for CDN live streaming, because the remote CDN live user
...
WujiStreamFallbackOptionDisabled. See WujiStreamFallbackOptions.
 @return * 0: Success.
* < 0: Failure.
 */
...
The default setting for `option` is `WujiStreamFallbackOptionVideoStreamLow`, where the remotely
...
If `option` is set as `WujiStreamFallbackOptionAudioOnly`, the SDK automatically switches the video
...
[didRemoteSubscribeFallbackToAudioOnly]([WujiRtcEngineDelegate
...
is `WujiStreamFallbackOptionVideoStreamLow`. See WujiStreamFallbackOptions.
 @return * 0: Success.
* < 0: Failure.
 */
...
/** Adds a voice or video stream RTMP URL address to a live broadcast.
 ...
 The [streamPublishedWithUrl]([WujiRtcEngineDelegate rtcEngine:streamPublishedWithUrl:errorCode:])
...
live show and interact with each other.
 ...
 - The local client:
   ...
   - [streamInjectedStatusOfUrl]([WujiRtcEngineDelegate
rtcEngine:streamInjectedStatusOfUrl:uid:status:]), with the state of the injecting the online
stream.
   - [didJoinedOfUid]([WujiRtcEngineDelegate rtcEngine:didJoinedOfUid:elapsed:])(uid: 666), if the
...
inject the stream and ensure that the URL is valid.
    ...
    - `WujiErrorCodeNotSupported`(-4): The channel profile is not Live Broadcast. Call the
[setChannelProfile]([WujiRtcEngineKit setChannelProfile:]) method and set the channel profile to
Live Broadcast before calling this method.
    - `WujiErrorCodeNotInitialized`(-7): The SDK is not initialized. Ensure that the RtcEngine
...
/** Removes the voice or video stream RTMP URL address from a live broadcast.
 ...
 If this method call is successful, the SDK triggers the [didOfflineOfUid]([WujiRtcEngineDelegate
...
/** Publishes the local stream to the CDN.
 ...
 This method call triggers the [rtmpStreamingChangedToState]([WujiRtcEngineDelegate
 ...
 **Note:**
 ...
 call the [setLiveTranscoding]([WujiRtcEngineKit setLiveTranscoding:]) method before this method.
...
[WujiRtcEngineKit](WujiRtcEngineKit).
...
[receiveStreamMessageFromUid]([WujiRtcEngineDelegate
...
[didOccurStreamMessageErrorFromUid]([WujiRtcEngineDelegate
...
[setVideoEncoderConfiguration]([WujiRtcEngineKit setVideoEncoderConfiguration:]), processing video
frames requires extra CPU and RAM usage and degrades performance. We recommend setting
`configuration` as WujiCameraCaptureOutputPreferencePerformance(1) to avoid such problems.
* If you do not need local video preview or are willing to sacrifice preview quality, we recommend
setting `configuration` as WujiCameraCaptureOutputPreferencePerformance(1) to optimize CPU and RAM
usage.
...
o[cameraFocusDidChangedToRect]([WujiRtcEngineDelegate rtcEngine:cameraFocusDidChangedToRect:])
...
[cameraExposureDidChangedToRect]([WujiRtcEngineDelegate rtcEngine:cameraExposureDidChangedToRect:])
callback on the local client.
...
[WujiScreenCaptureParameters](WujiScreenCaptureParameters).

@return * 0: Success.
* < 0: Failure.

    - `ERR_INVALID_STATE`: the screen sharing state is invalid, probably because another screen or
window is being shared. Call [stopScreenCapture]([WujiRtcEngineKit stopScreenCapture]) to stop the
...
window is being shared. Call [stopScreenCapture]([WujiRtcEngineKit stopScreenCapture]) to stop
...
[WujiVideoContentHint](WujiVideoContentHint).
 ...
 **Note:**
 ...
 @return An WujiRtcDeviceInfo NSArray object including all devices, if this method call is
 successful.
 */
...
volume information by using the [reportAudioVolumeIndicationOfSpeakers]([WujiRtcEngineDelegate
rtcEngine:reportAudioVolumeIndicationOfSpeakers:totalVolume:]) callback.

 @param indicationInterval Interval period (ms) of the
[reportAudioVolumeIndicationOfSpeakers]([WujiRtcEngineDelegate
...
[enableVideo]([WujiRtcEngineKit enableVideo]) method before calling this method and that the
...
[startAudioDeviceLoopbackTest]([WujiRtcEngineKit startAudioDeviceLoopbackTest:]) method.
...
/** Sets the data source of the metadata.
 ...
 Use this method with the [setMediaMetadataDelegate]([WujiRtcEngineKit
 ...
 **Note**
 ...
 - Call this method before the [joinChannelByToken]([WujiRtcEngineKit
 joinChannelByToken:channelId:info:uid:joinSuccess:]) method.
...
/** Allows a user to rate a call after the call ends.
 ...
 If you set a value out of this range, the WujiErrorCodeInvalidArgument(-2) error occurs.
 ...
 * < 0: Failure.
     ...
     * Return WujiErrorCodeInvalidArgument(-2)：The passed argument is invalid. For example,
 `callId` is invalid.
     * Return WujiErrorCodeNotReady(-3)：The SDK status is incorrect. For example, initialization
 fails.
 */
...
/** Retrieves the description of a warning or error code.
 ...
 @param code The warning or error code that the [didOccurWarning]([WujiRtcEngineDelegate
 rtcEngine:didOccurWarning:]) or [didOccurError]([WujiRtcEngineDelegate rtcEngine:didOccurError:])
 callback returns.
 ...
 **Note:**
 ...
 - The default log file location is as follows:
   ...
   - macOS
     - Sandbox enabled: `App Sandbox/Library/Logs/wujisdk.log`, for example
`/Users/<username>/Library/Containers/<App Bundle Identifier>/Data/Library/Logs/wujisdk.log`.
     - Sandbox disabled: `～/Library/Logs/wujisdk.log`.
 - Ensure that you call this method immediately after calling the
[sharedEngineWithAppId]([WujiRtcEngineKit sharedEngineWithAppId:delegate:]) method, otherwise the
 ...
 **DEPRECATED** from v3.0.0, use the [setupLocalVideo]([WujiRtcEngineKit setupLocalVideo:]) method
instead.
 ...
 **DEPRECATED** from v3.0.0, use the [setupRemoteVideo]([WujiRtcEngineKit setupRemoteVideo:]) method
instead.
...
* < 0: Failure.
 */
- (int)setRemoteRenderMode:(NSUInteger)uid mode:(WujiVideoRenderMode)mode;

/** Sets the local video mirror mode.

 **DEPRECATED** from v3.0.0, use the [setupLocalVideo]([WujiRtcEngineKit setupLocalVideo:]) or
[setLocalRenderMode]([WujiRtcEngineKit setLocalRenderMode:mirrorMode:]) method instead.
 ...
 **DEPRECATED** from v2.9.1. Use the new [addVideoWatermark]([WujiRtcEngineKit
...
* The URL descriptions are different for the local video and CDN live streams:
  * In a local video stream, `url` in WujiImage refers to the local file path of the added watermark
image file in the local video stream.
  * In a CDN live stream, `url` in WujiImage refers to the URL address of the added watermark image
...
* If you set `orientationMode` as `Adaptive` in the [setVideoEncoderConfiguration]([WujiRtcEngineKit
 ...
 **DEPRECATED** from v2.9.1. Use the new [startAudioRecording]([WujiRtcEngineKit
...
method after calling the [joinChannelByToken]([WujiRtcEngineKit
joinChannelByToken:channelId:info:uid:joinSuccess:]) method. The recording automatically stops when
you call the [leaveChannel]([WujiRtcEngineKit leaveChannel:]) method.
...
* < 0: Failure.
 */
- (int)startAudioRecording:(NSString *_Nonnull)filePath quality:(WujiAudioRecordingQuality)quality;
...
app cannot run the next echo test, nor can it call the [joinChannelByToken]([WujiRtcEngineKit
...
- (int)setVideoQualityParameters:(BOOL)preferFrameRateOverImageQuality
    __deprecated_msg("use WujiDegradationPreference instead.");
 ...
 **DEPRECATED** from v2.3.
 ...
 @param AppId    App ID issued to you by Wuji. Apply for a new App ID from Wuji if it is missing
 from your kit. Each project is assigned a unique App ID. The App ID identifies your project and
 organization in the [joinChannelByToken]([WujiRtcEngineKit
 joinChannelByToken:channelId:info:uid:joinSuccess:]) method to access the Wuji Global Network, and
...
+ (instancetype _Nonnull)sharedEngineWithAppId:(NSString *_Nonnull)AppId
                                         error:
                                             (void (^_Nullable)(WujiErrorCode errorCode))errorBlock
...
**DEPRECATED** from v2.4.
 ...
 @see [startScreenCaptureByDisplayId]([WujiRtcEngineKit
startScreenCaptureByDisplayId:rectangle:parameters:])
 @see [startScreenCaptureByWindowId]([WujiRtcEngineKit
 ...
 * Always set the video profile before calling the [joinChannelByToken]([WujiRtcEngineKit
joinChannelByToken:channelId:info:uid:joinSuccess:]) or [startPreview]([WujiRtcEngineKit
startPreview]) method.
 ...
 **DEPRECATED** from v2.3.
 ...
 If you do not need to change the video profile after joining the channel, Wuji recommends calling
 this method before calling the enableVideo method to reduce the render time of the first video
 frame.
 ...
 to the width, height, and frame rate. See the bitrate table in WujiVideoEncoderConfiguration. With
 ...
 * nil: Failure.
 */
- (NSString *_Nullable)getDeviceId:(WujiMediaDeviceType)type
...
[preloadEffect]([WujiRtcEngineKit preloadEffect:filePath:]) method, ensure that the `soundID` value
...
[stopEffect]([WujiRtcEngineKit stopEffect:]) or [stopAllEffects]([WujiRtcEngineKit stopAllEffects])
method
...
@see [reportAudioVolumeIndicationOfSpeakers]([WujiRtcEngineDelegate
 ...
 **DEPRECATED** from v1.1.
 ...
 @see [firstLocalVideoFrameWithSize]([WujiRtcEngineDelegate
 ...
 - elapsed: Time elapsed (ms) from the local user calling [joinChannelByToken]([WujiRtcEngineKit
 ...
 **DEPRECATED** from v1.1.
 ...
 @see [firstRemoteVideoFrameOfUid]([WujiRtcEngineDelegate
 ...
 - width:   Width (pixels) of the video stream.
 - height:  Height (pixels) of the video stream.
 - elapsed: Time elapsed (ms) from the remote user calling [joinChannelByToken]([WujiRtcEngineKit
 joinChannelByToken:channelId:info:uid:joinSuccess:]) until the SDK triggers this callback.
 */
 ...
 **DEPRECATED** from v1.1.
 ...
 @see [firstRemoteVideoDecodedOfUid]([WujiRtcEngineDelegate
 ...
 **DEPRECATED** from v1.1.
 ...
 - uid:     User ID. If the `uid` is specified in the [joinChannelByToken]([WujiRtcEngineKit
 joinChannelByToken:channelId:info:uid:joinSuccess:]) method, the specified user ID is returned. If
 the user ID is not specified in the joinChannel method, the server automatically assigns a `uid`.
 - elapsed: Time elapsed (ms) from the user calling  [joinChannelByToken]([WujiRtcEngineKit
 joinChannelByToken:channelId:info:uid:joinSuccess:]) until the SDK triggers this callback.
 */
 ...
 **DEPRECATED** from v1.1.
 ...
 Sometimes a weak network connection may lead to false detections; therefore, Wuji recommends using
 the [Wuji RTM
 SDK](https://docs.wuji.io/en/Real-time-Messaging/product_rtm?platform=All%20Platforms) for reliable
 offline detection.
 ...
 **DEPRECATED** from v1.1.
 ...
 @see [rtcEngineConnectionDidInterrupted]([WujiRtcEngineDelegate
 rtcEngineConnectionDidInterrupted:])
 ...
 */
- (void)rtcStatsBlock:(void (^_Nullable)(WujiChannelStats *_Nonnull stat))rtcStatsBlock
    __deprecated_msg("use delegate instead.");
 ...
 **DEPRECATED** from v1.1.
 ...
 When the app calls the [leaveChannel]([WujiRtcEngineKit leaveChannel:]) method, the SDK uses this
 ...
 received/transmitted data in the [audioQualityOfUid]([WujiRtcEngineDelegate
 rtcEngine:audioQualityOfUid:quality:delay:lost:]) callback.
 ...
 */
- (void)leaveChannelBlock:(void (^_Nullable)(WujiChannelStats *_Nonnull stat))leaveChannelBlock
    __deprecated_msg("use delegate instead.");
...
- (void)networkQualityBlock:(void (^_Nullable)(NSUInteger uid,
                                               WujiNetworkQuality txQuality,
                                               WujiNetworkQuality rxQuality))networkQualityBlock
    __deprecated_msg("use delegate instead.");
...
Last mile refers to the connection between the local device and Wuji's edge server. After the app
calls the [enableLastmileTest]([WujiRtcEngineKit enableLastmileTest]) method, this callback reports
 ...
 */
- (void)lastmileQualityBlock:(void (^_Nullable)(WujiNetworkQuality quality))lastmileQualityBlock
    __deprecated_msg("use delegate instead.");
