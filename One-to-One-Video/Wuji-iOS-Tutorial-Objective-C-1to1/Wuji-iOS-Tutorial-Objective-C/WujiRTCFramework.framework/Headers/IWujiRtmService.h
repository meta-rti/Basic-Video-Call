...
/**
 ...
 wuji::rtm::IRtmService::sendMessageToPeer(const char *peerId, const IMessage
 *message, const SendMessageOptions &options) "sendMessageToPeer" method to be
 compatible with the endCall method of the legacy Wuji Signaling SDK.
 */
#define WUJI_RTM_ENDCALL_PREFIX "WujiRTMLegacyEndcallCompatibleMessagePrefix"
...
enum LOGIN_ERR_CODE {
  ...
  /**
   8: The user has already logged in or is logging in the Wuji RTM system, or
   the user has not called the \ref wuji::rtm::IRtmService::logout "logout"
   method to leave the \ref wuji::rtm::CONNECTION_STATE_ABORTED
  ...
  /**
   10: The call frequency of the \ref wuji::rtm::IRtmService::login "login"
   method exceeds the limit of two queries per second.
   */
  LOGIN_ERR_TOO_OFTEN = 10,

  /**
   101: \ref wuji::rtm::IRtmService "IRtmService" is not initialized.
  */
...
enum LOGOUT_ERR_CODE {
  ...
  /**
   102: The user does not call the \ref wuji::rtm::IRtmService::login "login"
   method, or the method call of \ref wuji::rtm::IRtmService::login "login" does
   not succeed before the user logs out of the Wuji RTM system.
   */
...
enum RENEW_TOKEN_ERR_CODE {
  ...
  /**
   102: The user does not call the \ref wuji::rtm::IRtmService::login "login"
   method, or the method call of \ref wuji::rtm::IRtmService::login "login" does
   not succeed before renewing the token.
   */
  RENEW_TOKEN_ERR_USER_NOT_LOGGED_IN = 102,
};

/**
 @brief Connection states between the SDK and the Wuji RTM system.
 */
enum CONNECTION_STATE {
  ...
  /**
   ...
   When the user calls the \ref wuji::rtm::IRtmService::login "login" method,
   the SDK starts to log in the Wuji RTM system, triggers the \ref
   wuji::rtm::IRtmServiceEventHandler::onConnectionStateChanged
   "onConnectionStateChanged" callback, and switches to the \ref
   wuji::rtm::CONNECTION_STATE_CONNECTING "CONNECTION_STATE_CONNECTING" state.
   */
  ...
  /**
   ...
   - If the user successfully logs in the Wuji RTM system and receives the \ref
   wuji::rtm::IRtmServiceEventHandler::onLoginSuccess "onLoginSuccess" callback,
   the SDK triggers the \ref
   wuji::rtm::IRtmServiceEventHandler::onConnectionStateChanged
   "onConnectionStateChanged" callback and switches to the \ref
   wuji::rtm::CONNECTION_STATE_CONNECTED "CONNECTION_STATE_CONNECTED" state.
   - If the user fails to login the Wuji RTM system and receives the \ref
   wuji::rtm::IRtmServiceEventHandler::onLoginFailure "onLoginFailure" callback,
   the SDK triggers the \ref
   wuji::rtm::IRtmServiceEventHandler::onConnectionStateChanged
   "onConnectionStateChanged" callback and switches to the \ref
   wuji::rtm::CONNECTION_STATE_DISCONNECTED "CONNECTION_STATE_DISCONNECTED"
   state.
   */
  ...
  /**
   ...
   - If the connection state between the SDK and the Wuji RTM system is
   interrupted because of network issues, the SDK triggers the \ref
   wuji::rtm::IRtmServiceEventHandler::onConnectionStateChanged
   "onConnectionStateChanged" callback and switches to the \ref
   wuji::rtm::CONNECTION_STATE_RECONNECTING "CONNECTION_STATE_RECONNECTING"
   state.
   - If the login is banned by the server because, for example, another instance
   logs in the Wuji RTM system with the same user ID, the \ref
   wuji::rtm::IRtmServiceEventHandler::onConnectionStateChanged
   "onConnectionStateChanged" callback is triggered, and the SDK is switched to
   the \ref wuji::rtm::CONNECTION_STATE_ABORTED "CONNECTION_STATE_ABORTED"
   state.
   - If the user calls the \ref wuji::rtm::IRtmService::logout "logout" method
   to log out of the Wuji RTM system and receives the \ref
   wuji::rtm::IRtmServiceEventHandler::onLogout "onLogout" callback (error code
   = `LOGOUT_ERR_OK`), the SDK triggers the \ref
   wuji::rtm::IRtmServiceEventHandler::onConnectionStateChanged
   "onConnectionStateChanged" callback and switches to the \ref
   wuji::rtm::CONNECTION_STATE_DISCONNECTED "CONNECTION_STATE_DISCONNECTED"
   state.
  ...
  /**
   4: The connection state between the SDK and the Wuji RTM system is
   interrupted due to network issues, and the SDK keeps re-logging in the Wuji
   RTM system.

   - If the SDK successfully re-logs in the Wuji RTM system, the SDK triggers
   the \ref wuji::rtm::IRtmServiceEventHandler::onConnectionStateChanged
   "onConnectionStateChanged" callback and switches to the \ref
   wuji::rtm::CONNECTION_STATE_CONNECTED "CONNECTION_STATE_CONNECTED" state. The
   SDK automatically adds the user back to the channel(s) he or she was in when
   the connection was interrupted, and synchronizes the local user's attributes
   with the server.
   - If the SDK cannot re-log in the Wuji RTM system, it stays in the \ref
   wuji::rtm::CONNECTION_STATE_RECONNECTING "CONNECTION_STATE_RECONNECTING"
   state and keeps re-logging in the system.
   */
  CONNECTION_STATE_RECONNECTING = 4,

  /**
   5: The SDK gives up logging in the Wuji RTM system, mainly because another
   instance has logged in the Wuji RTM system with the same user ID.

   You must call the \ref wuji::rtm::IRtmService::logout "logout" method to
   leave this state before calling the \ref wuji::rtm::IRtmService::login
   "login" method again.
   */
...
enum CONNECTION_CHANGE_REASON {
  ...
  /**
   4: The SDK fails to log in the Wuji RTM system within six seconds and gives
   up.
   */
  CONNECTION_CHANGE_REASON_LOGIN_TIMEOUT = 4,

  /**
   5: The connection between the SDK and the Wuji RTM system is interrupted. The
   system defines an interruption when the SDK loses connection with the Wuji
   RTM system for network reasons and cannot recover in four seconds.
   */
  CONNECTION_CHANGE_REASON_INTERRUPTED = 5,

  /**
   6: The user has called the \ref wuji::rtm::IRtmService::logout "logout"
   method to log out of the Wuji RTM system.
   */
  CONNECTION_CHANGE_REASON_LOGOUT = 6,

  /**
   7: The SDK login to the Wuji RTM system is banned by Wuji.
   */
  CONNECTION_CHANGE_REASON_BANNED_BY_SERVER = 7,

  /**
   8: Another user is logging in the Wuji RTM system with the same User ID.
   */
...
enum PEER_MESSAGE_ERR_CODE {
  ...
  /**
   0: The method call succeeds, or the specified user receives the peer-to-peer
   message.
   */
  ...
  /**
   2: A timeout occurs when sending the peer-to-peer message. The current
   timeout is set as 10 seconds. Possible reasons: The user is in the \ref
   wuji::rtm::CONNECTION_STATE_ABORTED "CONNECTION_STATE_ABORTED" or \ref
   wuji::rtm::CONNECTION_STATE_RECONNECTING "CONNECTION_STATE_RECONNECTING"
   state.
   */
  ...
  /**
   3: The specified user is offline and does not receive this peer-to-peer
   message.
   */
  PEER_MESSAGE_ERR_PEER_UNREACHABLE = 3,

  /**
   4: The receiver is offline and does not receive this offline peer-to-peer
   message, but the server has cached it and will re-send it once he/she is back
   online.
   */
  PEER_MESSAGE_ERR_CACHED_BY_SERVER = 4,

  /**
   5: The method call frequency exceeds the limit of 60 queries per second
  ...
  /**
   8: The message receiver‘s SDK is of an earlier version and hence cannot
  ...
  /**
   102: The sender does not call the \ref wuji::rtm::IRtmService::login "login"
   method, or the method call of \ref wuji::rtm::IRtmService::login "login" does
   not succeed before sending the peer-to-peer message.
   */
...
enum JOIN_CHANNEL_ERR {
  ...
  /**
   4: A timeout occurs when joining the channel. The current timeout is set as
   five seconds. Possible reasons: The user is in the \ref
   wuji::rtm::CONNECTION_STATE_ABORTED "CONNECTION_STATE_ABORTED" or \ref
   wuji::rtm::CONNECTION_STATE_RECONNECTING "CONNECTION_STATE_RECONNECTING"
   state.
   */
  ...
  */
  ...
  /**
   8: The frequency of joining the same channel exceeds two times every five
   seconds.
   */
  ...
  /**
   102: The user does not call the \ref wuji::rtm::IRtmService::login "login"
   method, or the method call of \ref wuji::rtm::IRtmService::login "login" does
   not succeed before joining the channel.
   */
...
enum LEAVE_CHANNEL_ERR {
  ...
  /**
   102: The user does not call the \ref wuji::rtm::IRtmService::login "login"
   method, or the method call of \ref wuji::rtm::IRtmService::login "login" does
   not succeed before calling the \ref wuji::rtm::IChannel::leave "leave"
   method.
   */
...
enum CHANNEL_MESSAGE_ERR_CODE {
  ...
  /**
   ...
   \ref wuji::rtm::CONNECTION_STATE_ABORTED "CONNECTION_STATE_ABORTED" or \ref
   wuji::rtm::CONNECTION_STATE_RECONNECTING "CONNECTION_STATE_RECONNECTING"
   state.
   */
  ...
  /**
   3: The method call frequency exceeds the limit of 60 queries per second
   (channel and peer messages taken together).
   */
  ...
  /**
   102: The user does not call the \ref wuji::rtm::IRtmService::login "login"
   method, or the method call of \ref wuji::rtm::IRtmService::login "login" does
   not succeed before sending out a channel message.
   */
...
enum GET_MEMBERS_ERR {
  ...
  /**
   3: A timeout occurs when retrieving a member list of the channel. The current
   timeout is set as five seconds. Possible reasons: The user is in the \ref
   wuji::rtm::CONNECTION_STATE_ABORTED "CONNECTION_STATE_ABORTED" or \ref
   wuji::rtm::CONNECTION_STATE_RECONNECTING "CONNECTION_STATE_RECONNECTING"
   state.
   */
  ...
  /**
   102: The user does not call the \ref wuji::rtm::IRtmService::login "login"
   method, or the method call of \ref wuji::rtm::IRtmService::login "login" does
   not succeed before retrieving a member list.
   */
  GET_MEMBERS_ERR_USER_NOT_LOGGED_IN = 102,
};

/**
 @brief Error codes related to querying the online status of the specified
 peer(s).
 */
enum QUERY_PEERS_ONLINE_STATUS_ERR {
  ...
  /**
   1: Common failure. The user fails to query the online status of the specified
   peer(s).
   */
  ...
  /**
   5: The method call frequency exceeds the limit of 10 queries every five
   seconds.
   */
  ...
  /**
   102: The user does not call the \ref wuji::rtm::IRtmService::login "login"
   method, or the method call of \ref wuji::rtm::IRtmService::login "login" does
   not succeed before querying the online status.
   */
...
enum PEER_ONLINE_STATE {
  ...
  /**
   0: The peer is online (the SDK has logged in the Wuji RTM system).
   */
  PEER_ONLINE_STATE_ONLINE = 0,

  /**
   1: The peer is temporarily unreachable (the server has not received a packet
   from the SDK for more than six seconds).
   */
  PEER_ONLINE_STATE_UNREACHABLE = 1,

  /**
   2: The peer is offline (the SDK has not logged in the Wuji RTM system, or it
   has logged out of the system, or the server has not received a packet from
   the SDK for more than 30 seconds).
   */
...
/**
 @brief Error codes related to subscribing to or unsubscribing from the status
 of specified peer(s).
 */
enum PEER_SUBSCRIPTION_STATUS_ERR {
  ...
  /**
   1: Common failure. The user fails to subscribe to or unsubscribe from the
   status of the specified peer(s).
   */
  ...
  /**
   4: The SDK fails to receive a response from the server within 10 seconds. The
   current timeout is set as 10 seconds. Possible reasons: The user is in the
   \ref wuji::rtm::CONNECTION_STATE_ABORTED "CONNECTION_STATE_ABORTED" or \ref
   wuji::rtm::CONNECTION_STATE_RECONNECTING "CONNECTION_STATE_RECONNECTING"
   state.
...
/**
 @brief Error codes related to getting a list of the peer(s) by suscription
 option type.
 */
enum QUERY_PEERS_BY_SUBSCRIPTION_OPTION_ERR {
  ...
  /**
   1: Common failure. The user fails to query peer(s) by subscription option
   type.
   */
  QUERY_PEERS_BY_SUBSCRIPTION_OPTION_ERR_FAILURE = 1,

  /**
   2: The SDK fails to receive a response from the server within 5 seconds. The
   current timeout is set as 5 seconds. Possible reasons: The user is in the
   \ref wuji::rtm::CONNECTION_STATE_ABORTED "CONNECTION_STATE_ABORTED" or \ref
   wuji::rtm::CONNECTION_STATE_RECONNECTING "CONNECTION_STATE_RECONNECTING"
   state.
   */
  ...
  /**
   3: The method call frequency exceeds the limit of 10 queries every five
   seconds.
   */
...
enum ATTRIBUTE_OPERATION_ERR {
  ...
  /**
   3: The argument you put for this attribute operation is invalid. For example,
   you cannot set a user or channel attribute as "".
   */
  ...
  /**
   ...
   exceed the limit of 16 KB, one of the user's attributes would exceeds 8 KB in
   size, or the number of this user's attributes would exceed 32 after this
   attribute operation.
   - For channel attribute operations: The channel's overall attribute size
   would exceed the limit of 32 KB, one of the channel attributes would exceed 8
   KB in size, or the number of this channel's attributes would exceed 32 after
  ...
  /**
   ...
   - For \ref wuji::rtm::IRtmService::setLocalUserAttributes
   "setLocalUserAttributes", \ref
   wuji::rtm::IRtmService::addOrUpdateLocalUserAttributes
   "addOrUpdateLocalUserAttributes", \ref
   wuji::rtm::IRtmService::deleteLocalUserAttributesByKeys
   "deleteLocalUserAttributesByKeys" and \ref
   wuji::rtm::IRtmService::clearLocalUserAttributes "clearLocalUserAttributes"
   taken together: the call frequency limit is 10 queries every five seconds.
   - For \ref wuji::rtm::IRtmService::getUserAttributes "getUserAttributes" and
   \ref wuji::rtm::IRtmService::getUserAttributesByKeys
   "getUserAttributesByKeys" taken together, the call frequency limit is 40
   queries every five seconds.
   - For \ref wuji::rtm::IRtmService::setChannelAttributes
   "setChannelAttributes", \ref
   wuji::rtm::IRtmService::addOrUpdateChannelAttributes
   "addOrUpdateChannelAttributes", \ref
   wuji::rtm::IRtmService::deleteChannelAttributesByKeys
   "deleteChannelAttributesByKeys" and \ref
   wuji::rtm::IRtmService::clearChannelAttributes "clearChannelAttributes" taken
   together: the call frequency limit is 10 queries every five seconds.
   - For \ref wuji::rtm::IRtmService::getChannelAttributes
   "getChannelAttributes" and \ref
   wuji::rtm::IRtmService::getChannelAttributesByKeys
   "getChannelAttributesByKeys" taken together, the call frequency limit is 10
   queries every five seconds.
   */
  ...
  /**
   7: A timeout occurs during the attribute operation. The current timeout is
   set as five seconds. Possible reasons: The user is in the \ref
   wuji::rtm::CONNECTION_STATE_ABORTED "CONNECTION_STATE_ABORTED" or \ref
   wuji::rtm::CONNECTION_STATE_RECONNECTING "CONNECTION_STATE_RECONNECTING"
   state.
   */
  ...
  /**
   102: The user does not call the \ref wuji::rtm::IRtmService::login "login"
   method, or the method call of \ref wuji::rtm::IRtmService::login "login" does
   not succeed before the attribute operation.
   */
  ATTRIBUTE_OPERATION_ERR_USER_NOT_LOGGED_IN = 102,
};

/**
 @brief Error codes related to retrieving the channel member count of specified
 channel(s).
 */
...
enum DOWNLOAD_MEDIA_ERR_CODE {
  ...
  /**
   2: An argument you put is invalid. For example, `mediaId` is in the wrong
   format or `filePath` is set as `null`.
   */
  DOWNLOAD_MEDIA_ERR_INVALID_ARGUMENT = 2,
  /**
   3: A timeout occurs. The current timeout is set as 120 seconds. The SDK
   assumes that a timeout occurs if it has not detected any file transmission
   between the SDK and the file server for 120 seconds.
   */
  DOWNLOAD_MEDIA_ERR_TIMEOUT = 3,

  /**
   4: The file or image to download does not exist, either because the media ID
   you input is incorrect or because the validity of the media ID has expired.
   */
  DOWNLOAD_MEDIA_ERR_NOT_EXIST = 4,

  /**
   5: You have exceeded the upper limit for file download. You can initiate a
   maximum of nine file download or upload tasks at the same time (download and
   upload tasks count together).
   */
  DOWNLOAD_MEDIA_ERR_CONCURRENCY_LIMIT_EXCEEDED = 5,

  /**
   6: The file or image download task is aborted for either of the following
   reasons:

   - The user is in the \ref wuji::rtm::CONNECTION_STATE_ABORTED
   "CONNECTION_STATE_ABORTED" state.
...
enum UPLOAD_MEDIA_ERR_CODE {
  ...
  /**
   2: The argument you put is invalid. For example, `mediaId` is in the wrong
   format.
   */
  ...
  /**
   5: You have exceeded the upper limit for file upload. You can initiate a
   maximum of nine file upload or download tasks at the same time (upload and
   download tasks count together).
   */
  UPLOAD_MEDIA_ERR_CONCURRENCY_LIMIT_EXCEEDED = 5,
  /**
   6: The file or image upload task is aborted for either of the following
   reasons:

   - The user in the \ref wuji::rtm::CONNECTION_STATE_ABORTED
   "CONNECTION_STATE_ABORTED" state.
...
/**
 @brief Error codes related to cancelling a download task or cancelling an
 upload task.
 */
enum CANCEL_MEDIA_ERR_CODE {
  ...
  /**
   2: The task to cancel does not exist. You can only cancel an ongoing download
   or upload task. If the download or upload task completes, the corresponding
   @p requestId is no longer valid.
   */
...
struct SendMessageOptions {
  ...
  @note This setting applies to the peer-to-peer message only, not to the
  channel message.
  */
...
class IRtmChannelAttribute {
 ...
 public:
  /**
   ...
   @param key Key of channel attribute. Must be visible characters and not
   exceed 32 Bytes.
   */
  ...
  /**
   Release all resources used by the \ref wuji::rtm::IRtmChannelAttribute
...
struct ChannelAttributeOptions {
  /**
   ...
   - false: (Default) Do not notify all channel members of a channel attribute
   change.
   */
...
/**
 @brief The class for setting and retrieving attributes of a channel or
...
class IMessage {
 ...
 public:
  ...
  /**
   ...
   @param str The text message to be set. Must not exceed 32 KB in length. If
   the message is a raw message, ensure that the overall size of the text
   description and the raw message data does not exceed 32 KB.
   */
  ...
  /**
   ...
   @return The timestamp (ms) of when the messaging server receives this
   message.
   */
  virtual long long getServerReceivedTs() const = 0;

  /**
   Allows the receiver to check whether this message has been cached on the
   server (Applies to peer-to-peer message only).
   ...
   wuji::rtm::SendMessageOptions::enableOfflineMessaging
   "enableOfflineMessaging" as true) when the specified user is offline, does
   the method return true when the user is back online.
  ...
  /**
   Releases all resources used by the \ref wuji::rtm::IMessage "IMessage"
   instance.

   @note For the message receiver: please access and save the content of the
   IMessage instance when receiving the \ref
   wuji::rtm::IChannelEventHandler::onMessageReceived "onMessageReceived" or the
   \ref wuji::rtm::IRtmServiceEventHandler::onMessageReceivedFromPeer
...
class IFileMessage : public IMessage {
 public:
  ...
  /**
   ...
   @note
   - The media ID is automatically populated once the file is uploaded to the
   file server.
  ...
  /**
   ...
   @param fileName The name of the uploaded file. The size of @p thumbnail and
...
class IImageMessage : public IMessage {
 public:
  ...
  /**
   ...
   @note
   - The media ID is automatically populated once the image is uploaded to the
   file server.
   - The media ID is valid for 7 days because the file server keeps all uploaded
   files for 7 days only.
  ...
  /**
   ...
   @param length The length of the thumbnail in bytes. The size of @p thumbnail
  ...
  /**
   ...
   wuji::rtm::IImageMessage::getWidth() "getWidth" directly to get the width of
   the image.
   - Image width that is set by calling this method overrides the width
  ...
  /**
   ...
   - Image width that is set by calling \ref
   wuji::rtm::IImageMessage::setWidth() "setWidth" overrides the width
   calculated by the SDK.
  ...
  /**
   ...
   - If the uploaded image is in JPG, JPEG, BMP, or PNG format, the SDK
   automatically calculates the width and height of the image. You can call \ref
   wuji::rtm::IImageMessage::getHeight() "getHeight" directly to get the height
   of the image.
   - Image height that is set by calling this method overrides the height
   calculated by the SDK.

   @param height The height of the uploaded image. Is 0 if the SDK does not
   support the format of the uploaded image.
   */
  ...
  /**
   ...
   wuji::rtm::IImageMessage::setHeight() "setHeight" overrides the height
   calculated by the SDK.
  ...
  /**
   ...
   @note You need to work out the width of the thumbnail by yourself, because
   the SDK does not work out the value for you.
  ...
  /**
   ...
   @note You need to work out the height of the thumbnail by yourself, because
   the SDK does not work out the value for you.
...
class IChannelMember {
 ...
 public:
  ...
  /**
   Releases all resources used by the \ref wuji::rtm::IChannelMember
...
struct PeerOnlineStatus {
  ...
  /**
   @deprecated Deprecated as of v1.2.0. Use \ref
   wuji::rtm::PeerOnlineStatus::onlineState "onlineState" instead.

   The online status of the peer.

   - true: The user is online (the user has logged in the Wuji RTM system).
   - false: The user is offline (the user has logged out of the Wuji RTM system,
   has not logged in, or has failed to logged in).
   */
  bool isOnline;
  ...
  /**
   ...
   @note
   - The server will never return the `unreachable` state, if you <i>query</i>
   the online status of specified peer(s)
   (\ref wuji::rtm::IRtmService::queryPeersOnlineStatus
   "queryPeersOnlineStatus"). See also: \ref
   wuji::rtm::IRtmServiceEventHandler::onQueryPeersOnlineStatusResult
   "onQueryPeersOnlineStatusResult".
   - The server may return the `unreachable` state, if you <i>subscribe to</i>
   the online status of specified peer(s)
   (\ref wuji::rtm::IRtmService::subscribePeersOnlineStatus
   "subscribePeersOnlineStatus"). See also: \ref
   wuji::rtm::IRtmServiceEventHandler::onPeersOnlineStatusChanged
...
/**
 @brief The data structure holding a channel ID and the current channel member
 count.
 */
struct ChannelMemberCount {
  ...
  /**
   ...
   @note @p count is 0, if a channel with the specified @p channelId is not
   found.
   */
  int count;
};
...
/**
 @brief Callbacks for the Wuji RTM channel methods.
 */
class IChannelEventHandler {
 public:
  ...
  /**
   ...
   When the local user calls the \ref wuji::rtm::IChannel::join "join" method
   and successfully joins the channel:
   - The SDK triggers this callback;
   - All remote users in the channel receive the \ref
   wuji::rtm::IChannelEventHandler::onMemberJoined "onMemberJoined" callback.
   */
  ...
  /**
   ...
   The local user receives this callback when the \ref wuji::rtm::IChannel::join
  ...
  /**
   Returns the result of the \ref wuji::rtm::IChannel::leave "leave" method
   call.
  ...
  /**
   ...
   @param message The received channel message. See \ref wuji::rtm::IMessage
   "IMessage".
   */
  ...
  /**
   ...
   wuji::rtm::IImageMessage "IImageMessage".
   */
  ...
  /**
   ...
   wuji::rtm::IFileMessage "IFileMessage".
   */
  ...
  /**
   Returns the result of the \ref wuji::rtm::IChannel::sendMessage "sendMessage"
   method call.
  ...
  /**
   ...
   When a remote user calls the \ref wuji::rtm::IChannel::join "join" method and
   receives the \ref wuji::rtm::IChannelEventHandler::onJoinSuccess
  ...
  /**
   ...
   When a remote member in the channel calls the \ref wuji::rtm::IChannel::leave
   "leave" method and receives the the \ref
   wuji::rtm::IChannelEventHandler::onLeave "onLeave (LEAVE_CHANNEL_ERR_OK)"
  ...
  /**
   Occurs when channel attributes are updated, and returns all attributes of the
   channel.

   @note This callback is enabled only when the user, who updates the attributes
   of the channel, sets \ref
   wuji::rtm::ChannelAttributeOptions::enableNotificationToChannelMembers
   "enableNotificationToChannelMembers" as true. Also note that this flag is
   valid only within the current channel attribute method call.
...
/**
 @brief Wuji RTM channel methods.
 */
class IChannel {
 protected:
  virtual ~IChannel() {}
 ...
 public:
  //            virtual void setEventHandler(IChannelEventHandler *eventHandler)
  //            = 0;
  ...
  /**
   ...
   wuji::rtm::JOIN_CHANNEL_ERR "JOIN_CHANNEL_ERR_FAILURE" error code.

   - If this method call succeeds:
      - The local user receives the \ref
   wuji::rtm::IChannelEventHandler::onJoinSuccess "onJoinSuccess" callback.
      - All remote users receive the \ref
   wuji::rtm::IChannelEventHandler::onMemberJoined "onMemberJoined" callback.
   - If this method call fails, the local user receives the \ref
   wuji::rtm::IChannelEventHandler::onJoinFailure "onJoinFailure" callback. See
   #JOIN_CHANNEL_ERR for the error codes.
   @return
   - 0: Success.
  ...
  */
  ...
  /**
   ...
   - If this method call succeeds:
      - The local user receives the \ref
   wuji::rtm::IChannelEventHandler::onLeave "onLeave" callback with the
   LEAVE_CHANNEL_ERR_OK state.
      - All remote users receive the \ref
   wuji::rtm::IChannelEventHandler::onMemberLeft "onMemberLeft" callback.
   - If this method call fails, the local user receives the \ref
   wuji::rtm::IChannelEventHandler::onLeave "onLeave" callback with an error
   code. See \ref wuji::rtm::LEAVE_CHANNEL_ERR "LEAVE_CHANNEL_ERR" for the error
   codes.
   @return
   - 0: Success.
  ...
  /**
   @deprecated Allows a channel member to send a message to all members in the
   channel.

   Wuji does not recommend using this method to send a channel message. Use \ref
   wuji::rtm::IChannel::sendMessage(const IMessage *message, const
   SendMessageOptions &options) "sendMessage" instead.

   If this method call succeeds:
   - The \ref wuji::rtm::IChannelEventHandler::onSendMessageResult
   "onSendMessageResult" callback returns the result.
   - All remote users in the channel receive the \ref
   wuji::rtm::IChannelEventHandler::onMessageReceived "onMessageReceived"
   callback.

   @note You can send messages, including peer-to-peer and channel messages, at
   a maximum speed of 60 queries per second.

   @param message The message to be sent. See \ref wuji::rtm::IMessage
   "IMessage".
   @return
   - 0: Success.
  ...
  /**
   ...
   wuji::rtm::SendMessageOptions "SendMessageOptions".
   @return
   - 0: Success.
   - &ne;0: Failure. See #CHANNEL_MESSAGE_ERR_CODE for the error codes.
   */
  virtual int sendMessage(const IMessage* message,
  ...
  /**
   ...
   The \ref wuji::rtm::IChannelEventHandler::onGetMembers "onGetMembers"
   callback returns the result of this method call.

   @note You can call this method at a maximum speed of five queries every two
   seconds.
  ...
  /**
   Releases all resources used by the \ref wuji::rtm::IChannel "IChannel"
   instance.
   */
  virtual void release() = 0;
};
...
class IRtmServiceEventHandler {
 public:
  ...
  /**
   Occurs when a user logs in the Wuji RTM system.

   The local user receives this callback when the \ref
   wuji::rtm::IRtmService::login "login" method call succeeds.
   */
  virtual void onLoginSuccess() {}

  /**
   Occurs when a user fails to log in the Wuji RTM system.

   The local user receives this callback when the \ref
   wuji::rtm::IRtmService::login "login" method call fails. See \ref
  ...
  /**
   Reports the result of the \ref wuji::rtm::IRtmService::renewToken
  ...
  /**
   ...
   call the \ref wuji::rtm::IRtmService::renewToken "renewToken" method to pass
   the new Token on to the server.
   */
  virtual void onTokenExpired() {}

  /**
   Occurs when a user logs out of the Wuji RTM system.

   The local user receives this callback when the SDK calls the \ref
   wuji::rtm::IRtmService::logout "logout" method. See \ref
  ...
  /**
   Occurs when the connection state changes between the SDK and the Wuji RTM
   system.
  ...
  /**
   Reports the result of the \ref wuji::rtm::IRtmService::sendMessageToPeer
  ...
  /**
   ...
   wuji::rtm::IRtmService::createFileMessageByUploading
   "createFileMessageByUploading" method call.

   @param requestId The unique ID of the upload request.
   @param fileMessage An \ref wuji::rtm::IFileMessage "IFileMessage" instance.
  ...
  /**
   Reports the result of the \ref
   wuji::rtm::IRtmService::createImageMessageByUploading
   "createImageMessageByUploading" method call.

   @param requestId The unique ID of the upload request.
   @param imageMessage An \ref wuji::rtm::IImageMessage "IImageMessage"
   instance.
   @param code Error codes. See #UPLOAD_MEDIA_ERR_CODE.
   */
  ...
  /**
   Reports the result of the \ref wuji::rtm::IRtmService::downloadMediaToFile
  ...
  /**
   Reports the result of the \ref wuji::rtm::IRtmService::downloadMediaToMemory
   ...
   @param code Error codes. See #DOWNLOAD_MEDIA_ERR_CODE.
   */
  virtual void onMediaDownloadToMemoryResult(long long requestId,
                                             const char* memory,
                                             long long length,
                                             DOWNLOAD_MEDIA_ERR_CODE code) {
    (long long)requestId;
  ...
  /**
   Reports the result of the \ref wuji::rtm::IRtmService::cancelMediaDownload
   "cancelMediaDownload" or \ref wuji::rtm::IRtmService::cancelMediaUpload
  ...
  /**
   Reports the result of the \ref wuji::rtm::IRtmService::queryPeersOnlineStatus
  ...
  /**
   ...
   wuji::rtm::IRtmService::subscribePeersOnlineStatus
   "subscribePeersOnlineStatus" or \ref
   wuji::rtm::IRtmService::unsubscribePeersOnlineStatus
  ...
  /**
   Returns the result of the \ref
   wuji::rtm::IRtmService::queryPeersBySubscriptionOption
  ...
  /**
   Reports the result of the \ref wuji::rtm::IRtmService::setLocalUserAttributes
  ...
  /**
   Reports the result of the \ref wuji::rtm::IRtmService::getUserAttributes
   "getUserAttributes" or \ref wuji::rtm::IRtmService::getUserAttributesByKeys
   ...
   @param errorCode Error Codes. See #ATTRIBUTE_OPERATION_ERR.
   */
  virtual void onGetUserAttributesResult(long long requestId,
                                         const char* userId,
  ...
  /**
   Reports the result of the \ref wuji::rtm::IRtmService::setChannelAttributes
  ...
  /**
   Reports the result of the \ref wuji::rtm::IRtmService::clearChannelAttributes
  ...
  /**
   Reports the result of the \ref wuji::rtm::IRtmService::getChannelAttributes
  ...
  /**
   Reports the result of the \ref wuji::rtm::IRtmService::getChannelMemberCount
...
class IRtmService {
 ...
 public:
  /**
   ...
   @param appId The App ID issued by Wuji to you. Apply for a new App ID from
   Wuji if it is missing from your kit.
   @param eventHandler An IRtmServiceEventHandler object that invokes callbacks
   to be passed to the application on Wuji RTM SDK runtime events.
   @return
   - 0: Success.
   - < 0: Failure.
   */
  virtual int initialize(const char* appId,
                         IRtmServiceEventHandler* eventHandler) = 0;
  ...
  /**
   Releases all resources used by the \ref wuji::rtm::IRtmService "IRtmService"
   instance.
   */
  ...
  /**
   ...
   - If this method call fails, the local user receives the \ref
   wuji::rtm::IRtmServiceEventHandler::onLoginFailure "onLoginFailure" callback.
   See \ref wuji::rtm::LOGIN_ERR_CODE "LOGIN_ERR_CODE" for the error codes.

   @note
   - If you log in with the same user ID from a different instance, you will be
   kicked out of your previous login and removed from previously joined
   channels.
   - The call frequency limit for this method is 2 queries per second.
   - Only after you successfully call this method (when the local user receives
   the \ref wuji::rtm::IRtmServiceEventHandler::onLoginSuccess "onLoginSuccess"
   callback), can you call the key RTM methods except:
        - \ref wuji::rtm::IRtmService::createChannel "createChannel"
        - \ref wuji::rtm::IRtmService::createMessage "createMessage"
        - \ref wuji::rtm::IMessage::setText "setText"
        - \ref wuji::rtm::IRtmService::getRtmCallManager "getRtmCallManager"
        - \ref wuji::rtm::IRtmCallManager::createLocalCallInvitation
   "createLocalCallInvitation"
        - \ref wuji::rtm::IRtmService::createChannelAttribute
   "createChannelAttribute"

   @param token Token used to log in the Wuji RTM system and used when dynamic
   authentication is enabled. Set @p token as @p nil in the integration and test
   stages.
   @param userId The user ID of the user logging in Wuji's RTM system. The
   string must not exceed 64 bytes in length. It cannot be empty, null or
   "null". Supported characters:
  ...
  /**
   ...
   The local user receives the \ref wuji::rtm::IRtmServiceEventHandler::onLogout
   "onLogout" callback. See \ref wuji::rtm::LOGOUT_ERR_CODE "LOGIN_ERR_CODE" for
   the error codes.
  ...
  /**
   ...
   wuji::rtm::IRtmServiceEventHandler::onTokenExpired "onTokenExpired" callback,
   and the \ref wuji::rtm::IRtmServiceEventHandler::onRenewTokenResult
   "onRenewTokenResult" callback returns the result of this method call. The
   call frequency limit for this method is 2 queries per second.
  ...
  /**
   ...
   \ref wuji::rtm::IRtmService::sendMessageToPeer(const char *peerId, const
   IMessage *message, const SendMessageOptions &options) "sendMessageToPeer"
   instead.
   - You can send messages, including peer-to-peer and channel messages, at a
   maximum speed of 60 queries per second.

   @param peerId User ID of the receiver.
   @param message The message to be sent. For information about creating a
   message, see \ref wuji::rtm::IMessage "IMessage".
   @return
   - 0: Success.
   - &ne;0: Failure. See #PEER_MESSAGE_ERR_CODE for the error codes.
   */
  virtual int sendMessageToPeer(const char* peerId,
                                const IMessage* message) = 0;

  /**
   Downloads a file or image from the Wuji server to the local memory by media
   ID.

   The SDK returns the result of this method call by the \ref
   wuji::rtm::IRtmServiceEventHandler::onMediaDownloadToFileResult
   "onMediaDownloadToMemoryResult" callback.

   @note
   - This method applies to scenarios requiring quick access to the downloaded
   file or image.
   - The SDK releases the downloaded file or image immediately after returning
   the \ref wuji::rtm::IRtmServiceEventHandler::onMediaDownloadToFileResult
   "onMediaDownloadToMemoryResult" callback.
   ...
   */
  virtual int downloadMediaToMemory(const char* mediaId,
                                    long long& requestId) = 0;

  /**
   Downloads a file or image from the Wuji server to a specified local directory
   by media ID.

   The SDK returns the result of this method call by the \ref
   wuji::rtm::IRtmServiceEventHandler::onMediaDownloadToFileResult
   "onMediaDownloadToFileResult" callback.

   @param mediaId The media ID of the file or image on the Wuji server.
   @param filePath The full path to the downloaded file or image. Must be in
   UTF-8.
   @param requestId The unique ID of this download request.
   @return
   - 0: Success.
   - &ne;0: Failure. See #DOWNLOAD_MEDIA_ERR_CODE for the error codes.
   */
  virtual int downloadMediaToFile(const char* mediaId,
                                  const char* filePath,
                                  long long& requestId) = 0;
  ...
  /**
   ...
   wuji::rtm::IRtmServiceEventHandler::onMediaCancelResult "onMediaCancelResult"
   callback.

   @note
   You can only cancel an ongoing download task. After a download task
   completes, the corresponding request ID is no longer valid and hence you
   cannot cancel it.
  ...
  /**
   ...
   @note
   You can only cancel an ongoing upload task. After an upload task completes,
   you cannot cancel it and the corresponding request ID is no longer valid.
  ...
  /**
   ...
   This method allows you to send a message to a specified user when he/she is
   offline. If you set a message as an offline message and the specified user is
   offline when you send it, the RTM server caches it. Please note that for now
   we only cache 200 offline messages for up to seven days for each receiver.
   When the number of the cached messages reaches this limit, the newest message
   overrides the oldest one.

   If you use this method to send off a <i>text</i> message that starts off with
   WUJI_RTM_ENDCALL_PREFIX_\<channelId\>_\<your additional information\>, then
   this method is compatible with the endCall method of the legacy Wuji
   Signaling SDK. Replace \<channelId\> with the channel ID from which you want
   to leave (end call), and replace \<your additional information\> with any
   additional information. Note that you must not put any "_" (underscore" in
   your additional information but you can set \<your additional information\>
   as empty "".

   - The \ref wuji::rtm::IRtmServiceEventHandler::onSendMessageResult
   "onSendMessageResult" callback returns the result of this method call.
   - When the message arrives at the receiver, the receiver receives the \ref
   wuji::rtm::IRtmServiceEventHandler::onMessageReceivedFromPeer
   "onMessageReceivedFromPeer" callback.
   ...
   @param peerId User ID of the receiver. The string must not exceed 64 bytes in
   length. It cannot be empty, null, or "null". Supported characters:
  ...
  /**
   ...
   @note You can create multiple channels in an IRtmService instance. But you
   can only join a maximum of 20 channels at the same time. As a good practice,
   Agore recommends calling the \ref wuji::rtm::IChannel::release "release"
   method to release all resources of an RTM channel that you no longer use.

   @param channelId The unique channel name. A @p channelId cannot be empty,
   null, or "null". Must be less than 64 bytes in length. Supported characters:
   - All lowercase English letters: a to z
   - All uppercase English letters: A to Z
   - All numeric characters: 0 to 9
   - The space character.
   ...
   @return
   - An \ref wuji::rtm::IChannel "IChannel" object: Success.
   - null: Failure. Possible reasons: The @p channelId is invalid, or a channel
   with the same @p channelId already exists.
   */
  virtual IChannel* createChannel(const char* channelId,
                                  IChannelEventHandler* eventHandler) = 0;

  /**
   Gets an \ref wuji::rtm::IRtmCallManager "IRtmCallManager" object.

   Each \ref wuji::rtm::IRtmService "IRtmService" object corresponds to a unique
   \ref wuji::rtm::IRtmCallManager "IRtmCallManager" object. That said, the \ref
   wuji::rtm::IRtmCallManager "IRtmCallManager" object is \ref
   wuji::rtm::IRtmService "IRtmService"-specific.

   @note When you do no use \ref wuji::rtm::IRtmCallManager "IRtmCallManager",
   call the \ref wuji::rtm::IRtmCallManager::release "release" method to release
   all of its resources.

   @param eventHandler An \ref wuji::rtm::IRtmCallEventHandler
   "IRtmCallEventHandler" object.
  ...
  /**
   ...
   @note
   - An \ref wuji::rtm::IMessage "IMessage" instance can be used either for a
   channel message or for a peer-to-peer message.
   - When you no longer need an \ref wuji::rtm::IMessage "IMessage" instance,
   please call the \ref wuji::rtm::IMessage::release "release" method to release
   all resources that it is using.
   - You can set the content of the text message at a later point using the \ref
   wuji::rtm::IMessage::setText "setText" method, but please ensure that the
   size of the text message does not exceed 32 KB.

   @return An empty text \ref wuji::rtm::IMessage "IMessage" instance.
   */
  virtual IMessage* createMessage() = 0;

  /**
   Creates a text \ref wuji::rtm::IMessage "IMessage" instance.
   ...
   @param message The text content of the message. Must not exceed 32 KB in
   length.

   @return A text \ref wuji::rtm::IMessage "IMessage" instance.
   */
  virtual IMessage* createMessage(const char* message) = 0;

  /**
   Creates a raw \ref wuji::rtm::IMessage "IMessage" instance.
   ...
   please call the \ref wuji::rtm::IMessage::release "release" method to release
   all resources that it is using.
   - You can set a brief text description of the raw message at a later point
   using the \ref wuji::rtm::IMessage::setText "setText" method, but please
   ensure that the size of the raw message and the description combined does not
   exceed 32 KB.
   ...
   @return A raw \ref wuji::rtm::IMessage "IMessage" instance.
   */
  virtual IMessage* createMessage(const uint8_t* rawData, int length) = 0;

  /**
   Creates a raw \ref wuji::rtm::IMessage "IMessage" instance and sets its
   description.
   ...
   please call the \ref wuji::rtm::IMessage::release "release" method to release
   all resources that it is using.
   - You can set @p description as "" and add a brief text description of the
   raw message at a later point using the \ref wuji::rtm::IMessage::setText
   "setText" method, but please ensure that the size of the raw message and the
   description combined does not exceed 32 KB.

   @param rawData The starting address of the raw message.
   @param length The length of the raw message. Must not exceed 32 KB in length.
   @param description A brief text description of the raw message. If you set a
   text description, ensure that the size of the raw message and the description
   combined does not exceed 32 KB.

   @return A raw \ref wuji::rtm::IMessage "IMessage" instance with a brief text
   description.
   */
  virtual IMessage* createMessage(const uint8_t* rawData,
                                  int length,
                                  const char* description) = 0;

  /**
   Creates an \ref wuji::rtm::IFileMessage "IFileMessage" instance by media ID.

   - If you have at hand the media ID of a file on the Wuji server, you can call
   this method to create an \ref wuji::rtm::IFileMessage "IFileMessage"
   instance.
   - If you do not have a media ID, then you must call \ref
   wuji::rtm::IRtmService::createFileMessageByUploading
   "createFileMessageByUploading" to get a corresponding \ref
   wuji::rtm::IFileMessage "IFileMessage" instance by uploading a file to the
   Wuji RTM server.

   @param mediaId The media ID of an uploaded file on the Wuji server.
   @return An \ref wuji::rtm::IFileMessage "IFileMessage" instance.
   */
  virtual IFileMessage* createFileMessageByMediaId(const char* mediaId) = 0;

  /**
   Creates an \ref wuji::rtm::IImageMessage "IImageMessage" instance by media
   ID.

   - If you have at hand the media ID of an image on the Wuji server, you can
   call this method to create an \ref wuji::rtm::IImageMessage "IImageMessage"
   instance.
   - If you do not have a media ID, then you must call \ref
   wuji::rtm::IRtmService::createImageMessageByUploading
   "createImageMessageByUploading" to get a corresponding \ref
   wuji::rtm::IImageMessage "IImageMessage" instance by uploading an image to
   the Wuji RTM server.

   @param mediaId The media ID of an uploaded image on the Wuji server.
   @return An \ref wuji::rtm::IImageMessage "IImageMessage" instance.
   */
  virtual IImageMessage* createImageMessageByMediaId(const char* mediaId) = 0;

  /**
   Gets an \ref wuji::rtm::IFileMessage "IFileMessage" instance by uploading a
   file to the Wuji server.

   The SDK returns the result with the \ref
   wuji::rtm::IRtmServiceEventHandler::onFileMediaUploadResult callback. If
   success, this callback returns a corresponding \ref wuji::rtm::IFileMessage
   "IFileMessage" instance.

   @note
   - If you have at hand the media ID of a file on the Wuji server, you can call
   \ref wuji::rtm::IRtmService::createFileMessageByMediaId
   "createFileMessageByMediaId" to create an \ref wuji::rtm::IFileMessage
   "IFileMessage" instance.
   - To cancel an ongoing file upload task, call \ref
   wuji::rtm::IRtmService::cancelMediaUpload "cancelMediaUpload".
   ...
   */
  virtual int createFileMessageByUploading(const char* filePath,
                                           long long& requestId) = 0;

  /**
   Gets an \ref wuji::rtm::IImageMessage "IImageMessage" instance by uploading
   an image to the Wuji server.

   The SDK returns the result by the \ref
   wuji::rtm::IRtmServiceEventHandler::onImageMediaUploadResult callback. If
   success, this callback returns a corresponding \ref wuji::rtm::IImageMessage
   "ImageMessage" instance.

   - If the uploaded image is in JPEG, JPG, BMP, or PNG format, the SDK
   calculates the width and height of the image. You can call \ref
   wuji::rtm::IImageMessage::getWidth "getWidth" and \ref
   wuji::rtm::IImageMessage::getHeight "getHeight" to get the calculated width
   and height.
   - Otherwise, you need to call \ref wuji::rtm::IImageMessage::setWidth
   "setWidth" and \ref wuji::rtm::IImageMessage::setHeight "setHeight" to set
   the width and height of the uploaded image by yourself.

   @note
   - If you have at hand the media ID of an image on the Wuji server, you can
   call \ref wuji::rtm::IRtmService::createImageMessageByMediaId
   "createImageMessageByMediaId" to create an \ref wuji::rtm::IImageMessage
   "IImageMessage" instance.
   - To cancel an ongoing image upload task, call \ref
   wuji::rtm::IRtmService::cancelMediaUpload "cancelMediaUpload".
   ...
   - &ne;0: Failure. See #UPLOAD_MEDIA_ERR_CODE for the error codes.
   */
  virtual int createImageMessageByUploading(const char* filePath,
                                            long long& requestId) = 0;

  /**
   Creates an \ref wuji::rtm::IRtmChannelAttribute "IRtmChannelAttribute"
   instance.

   @return An \ref wuji::rtm::IRtmChannelAttribute "IRtmChannelAttribute"
   instance.
   */
  ...
  /**
   ...
   @note The JSON options are not public by default. Wuji is working on making
   commonly used JSON options public in a standard way. Contact
   [support@wuji.io](mailto:support@wuji.io) for more information.
  ...
  //            virtual int getParameters(const char* key, any_document_t&
  //            result) = 0;
   ...
   */
  virtual int queryPeersOnlineStatus(const char* peerIds[],
                                     int peerCount,
                                     long long& requestId) = 0;
  ...
  /**
   ...
   The SDK returns the result by the \ref
   wuji::rtm::IRtmServiceEventHandler::onSubscriptionRequestResult
   "onSubscriptionRequestResult" callback.

   - When the method call succeeds, the SDK returns the \ref
   wuji::rtm::IRtmServiceEventHandler::onPeersOnlineStatusChanged
   "onPeersOnlineStatusChanged" callback to report the online status of peers,
   to whom you subscribe.
   - When the online status of the peers, to whom you subscribe, changes, the
   SDK returns the \ref
   wuji::rtm::IRtmServiceEventHandler::onPeersOnlineStatusChanged
   "onPeersOnlineStatusChanged" callback to report whose online status has
   changed.
   - If the online status of the peers, to whom you subscribe, changes when the
   SDK is reconnecting to the server, the SDK returns the \ref
   wuji::rtm::IRtmServiceEventHandler::onPeersOnlineStatusChanged
   "onPeersOnlineStatusChanged" callback to report whose online status has
   changed when successfully reconnecting to the server.

   @note
   - When you log out of the Wuji RTM system, all the status that you subscribe
   to will be cleared. To keep the original subscription after you re-log in the
   system, you need to redo the whole subscription process.
   - When the SDK reconnects to the server from the state of being interupted,
   the SDK automatically subscribes to the peers and states before the
   interruption without human intervention.
   ...
   */
  virtual int subscribePeersOnlineStatus(const char* peerIds[],
                                         int peerCount,
                                         long long& requestId) = 0;
  ...
  /**
   ...
   - &ne;0: Failure. See #PEER_SUBSCRIPTION_STATUS_ERR for the error codes.
   */
  virtual int unsubscribePeersOnlineStatus(const char* peerIds[],
                                           int peerCount,
                                           long long& requestId) = 0;
  ...
  /**
   ...
   The SDK returns the result by the \ref
   wuji::rtm::IRtmServiceEventHandler::onQueryPeersBySubscriptionOptionResult
   "onQueryPeersBySubscriptionOptionResult" callback.

   @param option The status type, to which you have subscribed. See
   #PEER_SUBSCRIPTION_OPTION.
   @param requestId The unique ID of this request.
   @return
   - 0: Success.
   - &ne;0: Failure. See #QUERY_PEERS_BY_SUBSCRIPTION_OPTION_ERR for the error
   codes.
   */
  ...
  /**
   ...
   The SDK returns the result by the \ref
   wuji::rtm::IRtmServiceEventHandler::onSetLocalUserAttributesResult
   "onSetLocalUserAttributesResult" callback.

   @note For \ref wuji::rtm::IRtmService::setLocalUserAttributes
   "setLocalUserAttributes", \ref
   wuji::rtm::IRtmService::addOrUpdateLocalUserAttributes
   "addOrUpdateLocalUserAttributes", \ref
   wuji::rtm::IRtmService::deleteLocalUserAttributesByKeys
   ...
   */
  virtual int setLocalUserAttributes(const RtmAttribute* attributes,
                                     int numberOfAttributes,
                                     long long& requestId) = 0;
  ...
  /**
   ...
   This method updates the local user's attribute(s) if it finds that the
   attribute(s) has/have the same key(s), or adds attribute(s) to the local user
   if it does not.

   The SDK returns the result by the \ref
   wuji::rtm::IRtmServiceEventHandler::onAddOrUpdateLocalUserAttributesResult
   ...
   - &ne;0: Failure. See #ATTRIBUTE_OPERATION_ERR for the error codes.
   */
  virtual int addOrUpdateLocalUserAttributes(const RtmAttribute* attributes,
                                             int numberOfAttributes,
                                             long long& requestId) = 0;
  ...
  /**
   ...
   The SDK returns the result by the \ref
   wuji::rtm::IRtmServiceEventHandler::onDeleteLocalUserAttributesResult
   ...
   - &ne;0: Failure. See #ATTRIBUTE_OPERATION_ERR for the error codes.
   */
  virtual int deleteLocalUserAttributesByKeys(const char* attributeKeys[],
                                              int numberOfKeys,
                                              long long& requestId) = 0;
  ...
  /**
   ...
   The SDK returns the result by the \ref
   wuji::rtm::IRtmServiceEventHandler::onClearLocalUserAttributesResult
  ...
  /**
   ...
   The SDK returns the result by the \ref
   wuji::rtm::IRtmServiceEventHandler::onGetUserAttributesResult
   "onGetUserAttributesResult" callback.

   @note For \ref wuji::rtm::IRtmService::getUserAttributes "getUserAttributes"
   and \ref wuji::rtm::IRtmService::getUserAttributesByKeys
   "getUserAttributesByKeys" taken together, the call frequency limit is 40
   queries every five seconds.
  ...
  /**
   ...
   - &ne;0: Failure. See #ATTRIBUTE_OPERATION_ERR for the error codes.
   */
  virtual int getUserAttributesByKeys(const char* userId,
  ...
  /**
   ...
   The SDK returns the result by the \ref
   wuji::rtm::IRtmServiceEventHandler::onSetChannelAttributesResult
   "onSetChannelAttributesResult" callback.

   @note
   - You do not have to join the specified channel to update its attributes.
   - The attributes of a channel will be cleared if the channel remains empty
   (has no members) for a couple of minutes.
   - If more than one user can update the channel attributes, then Wuji
   recommends calling \ref wuji::rtm::IRtmService::getChannelAttributes
   "getChannelAttributes" to update the cache before calling this method.
   - For \ref wuji::rtm::IRtmService::setChannelAttributes
   "setChannelAttributes", \ref
   wuji::rtm::IRtmService::addOrUpdateChannelAttributes
   "addOrUpdateChannelAttributes", \ref
   ...
   @param attributes An array of channel attributes. See \ref
   wuji::rtm::IRtmChannelAttribute "IRtmChannelAttribute".
   @param numberOfAttributes The total number of the channel attributes.
   @param options Options for this attribute operation. See
   ...
   - &ne;0: Failure. See #ATTRIBUTE_OPERATION_ERR for the error codes.
   */
  virtual int setChannelAttributes(const char* channelId,
                                   const IRtmChannelAttribute* attributes[],
                                   int numberOfAttributes,
  ...
  /**
   ...
   This method updates the specified channel's attribute(s) if it finds that the
   attribute(s) has/have the same key(s), or adds attribute(s) to the channel if
   it does not.

   The SDK returns the result by the \ref
   wuji::rtm::IRtmServiceEventHandler::onAddOrUpdateChannelAttributesResult
  ...
  /**
   ...
   The SDK returns the result by the \ref
   wuji::rtm::IRtmServiceEventHandler::onDeleteChannelAttributesResult
  ...
  /**
   ...
   The SDK returns the result by the \ref
   wuji::rtm::IRtmServiceEventHandler::onClearChannelAttributesResult
   ...
   - &ne;0: Failure. See #ATTRIBUTE_OPERATION_ERR for the error codes.
   */
  virtual int clearChannelAttributes(const char* channelId,
                                     const ChannelAttributeOptions& options,
                                     long long& requestId) = 0;
  ...
  /**
   ...
   The SDK returns the result by the \ref
   wuji::rtm::IRtmServiceEventHandler::onGetChannelAttributesResult
   "onGetChannelAttributesResult" callback.
   ...
   - &ne;0: Failure. See #ATTRIBUTE_OPERATION_ERR for the error codes.
   */
  virtual int getChannelAttributes(const char* channelId,
                                   long long& requestId) = 0;
  ...
  /**
   ...
   - &ne;0: Failure. See #ATTRIBUTE_OPERATION_ERR for the error codes.
   */
  virtual int getChannelAttributesByKeys(const char* channelId,
                                         const char* attributeKeys[],
                                         int numberOfKeys,
                                         long long& requestId) = 0;
  ...
  /**
   ...
   The SDK returns the result by the \ref
   wuji::rtm::IRtmServiceEventHandler::onGetChannelMemberCountResult
   "onGetChannelMemberCountResult" callback.

   @note
   - The call frequency limit for this method is one query per second.
   - We do not support getting the member counts of more than 32 channels in one
   method call.
   ...
   */
  virtual int getChannelMemberCount(const char* channelIds[],
                                    int channelCount,
                                    long long& requestId) = 0;
  ...
  /**
   ...
   wuji::rtm::IRtmService::initialize "initialize" method to initialize an \ref
   wuji::rtm::IRtmService "IRtmService" instance, otherwise the output log may
   be incomplete.
   - For the Linux C++ platform, <i>wujirtm.log</i> is in the current working
   directory.

   @param logfile The absolute file path to the log file. The string of @p
   logfile is in UTF-8.
   @return
   - 0: Success.
   - &ne;0: Failure.
  ...
  /**
   ...
   sequence of OFF, CRITICAL, ERROR, WARNING, and INFO. Choose a level to see
   the logs preceding that level. If, for example, you set the log level to
  ...
  /**
   ...
   @note File size settings of less than 512 KB or greater than 10 MB will not
   take effect.
...
/**
Creates an \ref wuji::rtm::IRtmService "IRtmService" instance.

@note When you no longer need an \ref wuji::rtm::IRtmService "IRtmService"
instance, ensure that you call the \ref wuji::rtm::IRtmService::release
"release" method to release all resources that it uses.
