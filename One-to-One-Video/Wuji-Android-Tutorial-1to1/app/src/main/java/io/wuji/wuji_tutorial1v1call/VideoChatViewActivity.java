package io.wuji.wuji_tutorial1v1call;
...
import io.wuji.uikit.logger.LoggerRecyclerView;
...
public class VideoChatViewActivity extends AppCompatActivity {
    ...
    private void initializeEngine() {
        try {
            mRtcEngine = RtcEngine.create(getBaseContext(), getString(R.string.wuji_app_id), mRtcEventHandler);
        } catch (Exception e) {
    ...
    private void joinChannel() {
        ...
        String token = getString(R.string.wuji_access_token);
