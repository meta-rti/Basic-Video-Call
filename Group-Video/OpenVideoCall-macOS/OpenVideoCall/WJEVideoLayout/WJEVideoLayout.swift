...
struct WJEVideoLayout {
    ...
    func scrollType(_ type: ScrollType) -> WJEVideoLayout {
        var new = self
        new.scrollType = type
        return new
    }
    
    func size(_ size: ConstraintsType) -> WJEVideoLayout {
        var new = self
    ...
    func itemSize(_ itemSize: ConstraintsType) -> WJEVideoLayout {
        var new = self
    ...
    func startPoint(x: CGFloat? = nil, y: CGFloat? = nil) -> WJEVideoLayout {
        var new = self
        if let x = x {
            new.startPoint.x = x
        }
    ...
    func interitemSpacing(_ spacing: CGFloat) -> WJEVideoLayout {
        var new = self
        new.interitemSpacing = spacing
        return new
    }
    
    func lineSpacing(_ spacing: CGFloat) -> WJEVideoLayout {
        var new = self
...
extension WJEVideoLayout {
    ...
    static func ==(left: WJEVideoLayout, right: WJEVideoLayout) -> Bool {
        var isEqual = true
...
extension Array where Element == WJEVideoLayout.Equal.Reason {
    func containsOneOf(_ elements: [WJEVideoLayout.Equal.Reason]) -> Bool {
