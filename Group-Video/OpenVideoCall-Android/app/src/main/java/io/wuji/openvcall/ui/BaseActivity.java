...
import io.wuji.openvcall.model.CurrentUserSettings;
import io.wuji.openvcall.model.EngineConfig;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected WJApplication application() {
        return (WJApplication) getApplication();
    }
    ...
    protected void addEventHandler(WJEventHandler handler) {
        application().addEventHandler(handler);
    }

    protected void removeEventHandler(WJEventHandler handler) {
     ...
     *
     * When the connection between the client and Wuji's server is interrupted due to poor
     ...
     * on the local client.
     *
     * @param channel The unique channel name for the WujiRTC session in the string format.
     * @param uid User ID.
     */
    public final void joinChannel(final String channel, int uid) {
        String accessToken = getApplicationContext().getString(R.string.wuji_access_token);
