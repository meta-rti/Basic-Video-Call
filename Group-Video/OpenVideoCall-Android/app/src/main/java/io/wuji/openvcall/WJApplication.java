...
import io.wuji.openvcall.model.MyEngineEventHandler;
...
public class WJApplication extends Application {
    ...
    private void createRtcEngine() {
        ...
        String appId = context.getString(R.string.wuji_app_id);
        ...
        /*
          ...
          The Wuji RtcEngine differentiates channel profiles and applies different optimization
