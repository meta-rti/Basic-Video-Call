...
public abstract class BaseActivity extends AppCompatActivity {
     ...
     *
     * When the connection between the client and meta's server is interrupted due to poor
     ...
     * on the local client.
     *
     * @param channel The unique channel name for the metaRTC session in the string format.
     * @param uid User ID.
     */
    public final void joinChannel(final String channel, int uid) {
        String accessToken = getApplicationContext().getString(R.string.meta_access_token);
