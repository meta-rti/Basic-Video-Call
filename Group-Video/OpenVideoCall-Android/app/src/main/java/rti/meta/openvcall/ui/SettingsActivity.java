...
import rti.meta.openvcall.ui.layout.SettingsButtonDecoration;
import rti.meta.openvcall.ui.layout.VideoEncResolutionAdapter;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ab != null) {
            ...
            ab.setCustomView(R.layout.ard_meta_actionbar_with_back_btn);
        }
